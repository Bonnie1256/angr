...
libc.set_library_names(
    "libc.so.0", "libc.so.1", "libc.so.2", "libc.so.3", "libc.so.4", "libc.so.5", "libc.so.6", "libc.so.7", "libc.so"
)
libc.add_all_from_dict(P["libc"])
libc.add_all_from_dict(P["posix"])
libc.add_all_from_dict(P["glibc"])
libc.add_all_from_dict(
    P["uclibc"]
)  # gotta do this since there's no distinguishing different libcs without analysis. there should be no naming conflicts in the functions.
libc.set_non_returning(
    "exit_group",
    "exit",
    "abort",
    "pthread_exit",
...
_libc_decls = {
    ...
    "strerror": SimTypeFunction(
        [SimTypeInt(signed=True)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["errnum"]
    ),
    # char * strerror_r (int ERRNUM, char *BUF, size_t N);
    "strerror_r": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["errnum", "buf", "n"],
    ),
    # void perror (const char *MESSAGE);
    "perror": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeBottom(label="void"), arg_names=["message"]
    ),
    # void error (int STATUS, int ERRNUM, const char *FORMAT, ...);
    "error": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeBottom(label="void"),
        arg_names=["status", "errnum", "format"],
        variadic=True,
    ),
    # void error_at_line (int STATUS, int ERRNUM, const char *FNAME, unsigned int LINENO, const char *FORMAT, ...);
    "error_at_line": SimTypeFunction(
        [
        ...
        SimTypeBottom(label="void"),
        arg_names=["status", "errnum", "fname", "lineno", "format"],
        variadic=True,
    ),
    # void warn (const char *FORMAT, ...);
    "warn": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeBottom(label="void"), arg_names=["format"], variadic=True
    ),
    # void vwarn (const char *FORMAT, va_list AP);
    "vwarn": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeBottom(label="void"),
        arg_names=["format", "ap"],
    ),
    # void warnx (const char *FORMAT, ...);
    "warnx": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeBottom(label="void"), arg_names=["format"], variadic=True
    ),
    # void vwarnx (const char *FORMAT, va_list AP);
    "vwarnx": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeBottom(label="void"),
        arg_names=["format", "ap"],
    ),
    ...
    "err": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeBottom(label="void"),
        arg_names=["status", "format"],
        variadic=True,
    ),
    # void verr (int STATUS, const char *FORMAT, va_list AP);
    "verr": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeBottom(label="void"),
        arg_names=["status", "format", "ap"],
    ),
    # void errx (int STATUS, const char *FORMAT, ...);
    "errx": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeBottom(label="void"),
        arg_names=["status", "format"],
        variadic=True,
    ...
    "verrx": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeBottom(label="void"),
        arg_names=["status", "format", "ap"],
    ),
    # void * malloc (size_t SIZE);
    "malloc": SimTypeFunction(
        [SimTypeLong(signed=False, label="size_t")],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["size"],
    ),
    # void free (void *PTR);
    "free": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0)], SimTypeBottom(label="void"), arg_names=["ptr"]
    ),
    # void * realloc (void *PTR, size_t NEWSIZE);
    "realloc": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["ptr", "newsize"],
    ),
    # void * reallocarray (void *PTR, size_t NMEMB, size_t SIZE);
    "reallocarray": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypeLong(signed=False, label="size_t"),
        ...
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["ptr", "nmemb", "size"],
    ),
    # void * calloc (size_t COUNT, size_t ELTSIZE);
    "calloc": SimTypeFunction(
        [SimTypeLong(signed=False, label="size_t"), SimTypeLong(signed=False, label="size_t")],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["count", "eltsize"],
    ),
    # void * aligned_alloc (size_t ALIGNMENT, size_t SIZE);
    "aligned_alloc": SimTypeFunction(
        [SimTypeLong(signed=False, label="size_t"), SimTypeLong(signed=False, label="size_t")],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["alignment", "size"],
    ),
    # void * memalign (size_t BOUNDARY, size_t SIZE);
    "memalign": SimTypeFunction(
        [SimTypeLong(signed=False, label="size_t"), SimTypeLong(signed=False, label="size_t")],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["boundary", "size"],
    ),
    # int posix_memalign (void **MEMPTR, size_t ALIGNMENT, size_t SIZE);
    "posix_memalign": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(SimTypeBottom(label="void"), offset=0), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypeLong(signed=False, label="size_t"),
        ],
        SimTypeInt(signed=True),
        arg_names=["memptr", "alignment", "size"],
    ),
    # void * valloc (size_t SIZE);
    "valloc": SimTypeFunction(
        [SimTypeLong(signed=False, label="size_t")],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["size"],
    ),
    # int mallopt (int PARAM, int VALUE);
    "mallopt": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["param", "value"]
    ),
    ...
    "obstack_init": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["obstack"], offset=0)], SimTypeInt(signed=True), arg_names=["obstack_ptr"]
    ),
    # void * obstack_alloc (struct obstack *OBSTACK_PTR, int SIZE);
    "obstack_alloc": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["obstack"], offset=0), SimTypeInt(signed=True)],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["obstack_ptr", "size"],
    ),
    # void * obstack_copy (struct obstack *OBSTACK_PTR, void *ADDRESS, int SIZE);
    "obstack_copy": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["obstack"], offset=0),
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeInt(signed=True),
        ],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["obstack_ptr", "address", "size"],
    ),
    # void * obstack_copy0 (struct obstack *OBSTACK_PTR, void *ADDRESS, int SIZE);
    "obstack_copy0": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["obstack"], offset=0),
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeInt(signed=True),
    ...
    "obstack_free": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["obstack"], offset=0), SimTypePointer(SimTypeBottom(label="void"), offset=0)],
        SimTypeBottom(label="void"),
        arg_names=["obstack_ptr", "object"],
    ),
    # void obstack_blank (struct obstack *OBSTACK_PTR, int SIZE);
    "obstack_blank": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["obstack"], offset=0), SimTypeInt(signed=True)],
        SimTypeBottom(label="void"),
        arg_names=["obstack_ptr", "size"],
    ),
    # void obstack_grow (struct obstack *OBSTACK_PTR, void *DATA, int SIZE);
    "obstack_grow": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["obstack"], offset=0),
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeInt(signed=True),
    ...
    # int brk (void *ADDR);
    "brk": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0)], SimTypeInt(signed=True), arg_names=["addr"]
    ),
    # void *sbrk (ptrdiff_t DELTA);
    "sbrk": SimTypeFunction(
        [SimTypeLong(signed=True, label="ptrdiff_t")],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["delta"],
    ),
    # int mlock (const void *ADDR, size_t LEN);
    "mlock": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["addr", "len"],
    ),
    # int munlock (const void *ADDR, size_t LEN);
    "munlock": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["addr", "len"],
    ),
    ...
    "wctype": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeShort(signed=False, label="wctype_t"), arg_names=["property"]
    ),
    # int iswctype (wint_t WC, wctype_t DESC);
    "iswctype": SimTypeFunction(
        [SimTypeInt(signed=False, label="wint_t"), SimTypeShort(signed=False, label="wctype_t")],
        SimTypeInt(signed=True),
        arg_names=["wc", "desc"],
    ),
    ...
    "wctrans": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeShort(signed=False, label="wctrans_t"), arg_names=["property"]
    ),
    # wint_t towctrans (wint_t WC, wctrans_t DESC);
    "towctrans": SimTypeFunction(
        [SimTypeInt(signed=False, label="wint_t"), SimTypeShort(signed=False, label="wctrans_t")],
        SimTypeInt(signed=False, label="wint_t"),
        arg_names=["wc", "desc"],
    ),
    # wint_t towlower (wint_t WC);
    "towlower": SimTypeFunction(
        [SimTypeInt(signed=False, label="wint_t")], SimTypeInt(signed=False, label="wint_t"), arg_names=["wc"]
    ),
    # wint_t towupper (wint_t WC);
    "towupper": SimTypeFunction(
        [SimTypeInt(signed=False, label="wint_t")], SimTypeInt(signed=False, label="wint_t"), arg_names=["wc"]
    ),
    # size_t strlen (const char *S);
    "strlen": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeLong(signed=False, label="size_t"), arg_names=["s"]
    ),
    # size_t wcslen (const wchar_t *WS);
    "wcslen": SimTypeFunction(
        [SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0)],
        SimTypeLong(signed=False, label="size_t"),
        arg_names=["ws"],
    ),
    # size_t strnlen (const char *S, size_t MAXLEN);
    "strnlen": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeLong(signed=False, label="size_t"),
        arg_names=["s", "maxlen"],
    ),
    # size_t wcsnlen (const wchar_t *WS, size_t MAXLEN);
    "wcsnlen": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
        ],
    ...
    "memccpy": SimTypeFunction(
        ...
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["to", "from", "c", "size"],
    ),
    # void * memset (void *BLOCK, int C, size_t SIZE);
    "memset": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeInt(signed=True),
            SimTypeLong(signed=False, label="size_t"),
        ...
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["block", "c", "size"],
    ),
    # wchar_t * wmemset (wchar_t *BLOCK, wchar_t WC, size_t SIZE);
    "wmemset": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypeShort(signed=False, label="wchar_t"),
            SimTypeLong(signed=False, label="size_t"),
        ],
        SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        arg_names=["block", "wc", "size"],
    ),
    # char * strcpy (char *restrict TO, const char *restrict FROM);
    "strcpy": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["to", "from"],
    ),
    # wchar_t * wcscpy (wchar_t *restrict WTO, const wchar_t *restrict WFROM);
    "wcscpy": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
    ...
    "strdup": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["s"]
    ),
    # wchar_t * wcsdup (const wchar_t *WS);
    "wcsdup": SimTypeFunction(
        [SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0)],
        SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        arg_names=["ws"],
    ),
    # char * stpcpy (char *restrict TO, const char *restrict FROM);
    "stpcpy": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["to", "from"],
    ),
    # wchar_t * wcpcpy (wchar_t *restrict WTO, const wchar_t *restrict WFROM);
    "wcpcpy": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
    ...
    "bcopy": SimTypeFunction(
        ...
        SimTypeBottom(label="void"),
        arg_names=["from", "to", "size"],
    ),
    # void bzero (void *BLOCK, size_t SIZE);
    "bzero": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeBottom(label="void"),
        arg_names=["block", "size"],
    ),
    # char * strcat (char *restrict TO, const char *restrict FROM);
    "strcat": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["to", "from"],
    ),
    # wchar_t * wcscat (wchar_t *restrict WTO, const wchar_t *restrict WFROM);
    "wcscat": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
    ...
    "memcmp": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["a1", "a2", "size"],
    ),
    # int wmemcmp (const wchar_t *A1, const wchar_t *A2, size_t SIZE);
    "wmemcmp": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
    ...
    "strcmp": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["s1", "s2"],
    ),
    # int wcscmp (const wchar_t *WS1, const wchar_t *WS2);
    "wcscmp": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
    ...
    "strcasecmp": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["s1", "s2"],
    ),
    # int wcscasecmp (const wchar_t *WS1, const wchar_t *WS2);
    "wcscasecmp": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
    ...
    "wcsncmp": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["ws1", "ws2", "size"],
    ),
    # int strncasecmp (const char *S1, const char *S2, size_t N);
    "strncasecmp": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
    ...
    "strverscmp": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["s1", "s2"],
    ),
    # int bcmp (const void *A1, const void *A2, size_t SIZE);
    "bcmp": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
    ...
    "strcoll": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["s1", "s2"],
    ),
    # int wcscoll (const wchar_t *WS1, const wchar_t *WS2);
    "wcscoll": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
    ...
    "strchr": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["string", "c"],
    ),
    # wchar_t * wcschr (const wchar_t *WSTRING, int WC);
    "wcschr": SimTypeFunction(
        [SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0), SimTypeInt(signed=True)],
        SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        arg_names=["wstring", "wc"],
    ),
    # char * strchrnul (const char *STRING, int C);
    "strchrnul": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["string", "c"],
    ),
    # wchar_t * wcschrnul (const wchar_t *WSTRING, wchar_t WC);
    "wcschrnul": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypeShort(signed=False, label="wchar_t"),
        ],
    ...
    "strstr": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["haystack", "needle"],
    ),
    # wchar_t * wcsstr (const wchar_t *HAYSTACK, const wchar_t *NEEDLE);
    "wcsstr": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
    ...
    "strcasestr": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["haystack", "needle"],
    ),
    # void * memmem (const void *HAYSTACK, size_t HAYSTACK_LEN, const void *NEEDLE, size_t NEEDLE_LEN);
    "memmem": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
        ...
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["haystack", "haystack_len", "needle", "needle_len"],
    ),
    # size_t strspn (const char *STRING, const char *SKIPSET);
    "strspn": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeLong(signed=False, label="size_t"),
        arg_names=["string", "skipset"],
    ),
    # size_t wcsspn (const wchar_t *WSTRING, const wchar_t *SKIPSET);
    "wcsspn": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
        SimTypeLong(signed=False, label="size_t"),
        arg_names=["wstring", "skipset"],
    ),
    # size_t strcspn (const char *STRING, const char *STOPSET);
    "strcspn": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeLong(signed=False, label="size_t"),
        arg_names=["string", "stopset"],
    ),
    # size_t wcscspn (const wchar_t *WSTRING, const wchar_t *STOPSET);
    "wcscspn": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
        SimTypeLong(signed=False, label="size_t"),
        arg_names=["wstring", "stopset"],
    ),
    # char * strpbrk (const char *STRING, const char *STOPSET);
    "strpbrk": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["string", "stopset"],
    ),
    # wchar_t * wcspbrk (const wchar_t *WSTRING, const wchar_t *STOPSET);
    "wcspbrk": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
    ...
    "index": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["string", "c"],
    ),
    # char * rindex (const char *STRING, int C);
    "rindex": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["string", "c"],
    ),
    # char * strtok (char *restrict NEWSTRING, const char *restrict DELIMITERS);
    "strtok": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["newstring", "delimiters"],
    ),
    ...
    "wcstok": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0), offset=0),
        ],
        SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        arg_names=["newstring", "delimiters", "save_ptr"],
    ),
    # char * strtok_r (char *NEWSTRING, const char *DELIMITERS, char **SAVE_PTR);
    "strtok_r": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
        ],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["newstring", "delimiters", "save_ptr"],
    ),
    # char * strsep (char **STRING_PTR, const char *DELIMITER);
    "strsep": SimTypeFunction(
        [SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["string_ptr", "delimiter"],
    ),
    # char * basename (const char *PATH);
    "basename": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["path"]
    ),
    # char * dirname (char *PATH);
    "dirname": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["path"]
    ),
    # void explicit_bzero (void *BLOCK, size_t LEN);
    "explicit_bzero": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeBottom(label="void"),
        arg_names=["block", "len"],
    ),
    # char * strfry (char *STRING);
    "strfry": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["string"]
    ),
    # void * memfrob (void *MEM, size_t LENGTH);
    "memfrob": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["mem", "length"],
    ),
    ...
    "argz_count": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeLong(signed=False, label="size_t"),
        arg_names=["argz", "argz_len"],
    ),
    # void argz_extract (const char *ARGZ, size_t ARGZ_LEN, char **ARGV);
    "argz_extract": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
        ...
        SimTypeBottom(label="void"),
        arg_names=["argz", "argz_len", "argv"],
    ),
    # void argz_stringify (char *ARGZ, size_t LEN, int SEP);
    "argz_stringify": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t"), SimTypeInt(signed=True)],
        SimTypeBottom(label="void"),
        arg_names=["argz", "len", "sep"],
    ),
    ...
    "argz_delete": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
            SimTypePointer(SimTypeLong(signed=False, label="size_t"), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
        ],
        SimTypeBottom(label="void"),
        arg_names=["argz", "argz_len", "entry"],
    ),
    # error_t argz_insert (char **ARGZ, size_t *ARGZ_LEN, char *BEFORE, const char *ENTRY);
    "argz_insert": None,
    # char * argz_next (const char *ARGZ, size_t ARGZ_LEN, const char *ENTRY);
    "argz_next": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeChar(), offset=0),
    ...
    "envz_entry": SimTypeFunction(
        ...
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["envz", "envz_len", "name"],
    ),
    # char * envz_get (const char *ENVZ, size_t ENVZ_LEN, const char *NAME);
    "envz_get": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeChar(), offset=0),
    ...
    "envz_strip": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
            SimTypePointer(SimTypeLong(signed=False, label="size_t"), offset=0),
        ],
        SimTypeBottom(label="void"),
        arg_names=["envz", "envz_len"],
    ),
    # void envz_remove (char **ENVZ, size_t *ENVZ_LEN, const char *NAME);
    "envz_remove": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
            SimTypePointer(SimTypeLong(signed=False, label="size_t"), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
    ...
    "mbtowc": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["result", "string", "size"],
    ),
    # int wctomb (char *STRING, wchar_t WCHAR);
    "wctomb": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeShort(signed=False, label="wchar_t")],
        SimTypeInt(signed=True),
        arg_names=["string", "wchar"],
    ),
    # int mblen (const char *STRING, size_t SIZE);
    "mblen": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["string", "size"],
    ),
    # size_t mbstowcs (wchar_t *WSTRING, const char *STRING, size_t SIZE);
    "mbstowcs": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
        ...
        SimTypeLong(signed=False, label="size_t"),
        arg_names=["wstring", "string", "size"],
    ),
    # size_t wcstombs (char *STRING, const wchar_t *WSTRING, size_t SIZE);
    "wcstombs": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
    ...
    "setlocale": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["category", "locale"],
    ),
    ...
    "strfmon": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeChar(), offset=0),
        ],
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["s", "maxsize", "format"],
        variadic=True,
    ),
    # int rpmatch (const char *RESPONSE);
    "rpmatch": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["response"]
    ),
    ...
    "gettext": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["msgid"]
    ),
    # char * dgettext (const char *DOMAINNAME, const char *MSGID);
    "dgettext": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["domainname", "msgid"],
    ),
    # char * dcgettext (const char *DOMAINNAME, const char *MSGID, int CATEGORY);
    "dcgettext": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["domainname", "msgid", "category"],
    ),
    # char * textdomain (const char *DOMAINNAME);
    "textdomain": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["domainname"]
    ),
    # char * bindtextdomain (const char *DOMAINNAME, const char *DIRNAME);
    "bindtextdomain": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["domainname", "dirname"],
    ),
    # char * ngettext (const char *MSGID1, const char *MSGID2, unsigned long int N);
    "ngettext": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["msgid1", "msgid2", "n"],
    ),
    # char * dngettext (const char *DOMAIN, const char *MSGID1, const char *MSGID2, unsigned long int N);
    "dngettext": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
    ...
    "dcngettext": SimTypeFunction(
        ...
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["domain", "msgid1", "msgid2", "n", "category"],
    ),
    # char * bind_textdomain_codeset (const char *DOMAINNAME, const char *CODESET);
    "bind_textdomain_codeset": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["domainname", "codeset"],
    ),
    ...
    "hcreate_r": SimTypeFunction(
        [SimTypeLong(signed=False, label="size_t"), SimTypePointer(ALL_TYPES["hsearch_data"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["nel", "htab"],
    ),
    # void hdestroy_r (struct hsearch_data *HTAB);
    "hdestroy_r": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["hsearch_data"], offset=0)], SimTypeBottom(label="void"), arg_names=["htab"]
    ),
    ...
    "fnmatch": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["pattern", "string", "flags"],
    ),
    ...
    "fopen": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        arg_names=["filename", "opentype"],
    ),
    # FILE * fopen64 (const char *FILENAME, const char *OPENTYPE);
    "fopen64": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        arg_names=["filename", "opentype"],
    ),
    # FILE * freopen (const char *FILENAME, const char *OPENTYPE, FILE *STREAM);
    "freopen": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        ...
        SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        arg_names=["filename", "opentype", "stream"],
    ),
    # FILE * freopen64 (const char *FILENAME, const char *OPENTYPE, FILE *STREAM);
    "freopen64": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
    ...
    "__freadable": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int __fwritable (FILE *STREAM);
    "__fwritable": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int __freading (FILE *STREAM);
    "__freading": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int __fwriting (FILE *STREAM);
    "__fwriting": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int fclose (FILE *STREAM);
    "fclose": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int fcloseall (void);
    "fcloseall": SimTypeFunction([], SimTypeInt(signed=True)),
    # void flockfile (FILE *STREAM);
    "flockfile": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeBottom(label="void"), arg_names=["stream"]
    ),
    # int ftrylockfile (FILE *STREAM);
    "ftrylockfile": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # void funlockfile (FILE *STREAM);
    "funlockfile": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeBottom(label="void"), arg_names=["stream"]
    ),
    # int __fsetlocking (FILE *STREAM, int TYPE);
    "__fsetlocking": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["stream", "type"],
    ),
    # int fwide (FILE *STREAM, int MODE);
    "fwide": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["stream", "mode"],
    ),
    # int fputc (int C, FILE *STREAM);
    "fputc": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["c", "stream"],
    ),
    # wint_t fputwc (wchar_t WC, FILE *STREAM);
    "fputwc": SimTypeFunction(
        [SimTypeShort(signed=False, label="wchar_t"), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=False, label="wint_t"),
        arg_names=["wc", "stream"],
    ),
    # int fputc_unlocked (int C, FILE *STREAM);
    "fputc_unlocked": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["c", "stream"],
    ),
    # wint_t fputwc_unlocked (wchar_t WC, FILE *STREAM);
    "fputwc_unlocked": SimTypeFunction(
        [SimTypeShort(signed=False, label="wchar_t"), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=False, label="wint_t"),
        arg_names=["wc", "stream"],
    ),
    # int putc (int C, FILE *STREAM);
    "putc": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["c", "stream"],
    ),
    # wint_t putwc (wchar_t WC, FILE *STREAM);
    "putwc": SimTypeFunction(
        [SimTypeShort(signed=False, label="wchar_t"), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=False, label="wint_t"),
        arg_names=["wc", "stream"],
    ),
    # int putc_unlocked (int C, FILE *STREAM);
    "putc_unlocked": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["c", "stream"],
    ),
    # wint_t putwc_unlocked (wchar_t WC, FILE *STREAM);
    "putwc_unlocked": SimTypeFunction(
        [SimTypeShort(signed=False, label="wchar_t"), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=False, label="wint_t"),
        arg_names=["wc", "stream"],
    ),
    ...
    "putwchar": SimTypeFunction(
        [SimTypeShort(signed=False, label="wchar_t")], SimTypeInt(signed=False, label="wint_t"), arg_names=["wc"]
    ),
    # int putchar_unlocked (int C);
    "putchar_unlocked": SimTypeFunction([SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["c"]),
    # wint_t putwchar_unlocked (wchar_t WC);
    "putwchar_unlocked": SimTypeFunction(
        [SimTypeShort(signed=False, label="wchar_t")], SimTypeInt(signed=False, label="wint_t"), arg_names=["wc"]
    ),
    # int fputs (const char *S, FILE *STREAM);
    "fputs": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["s", "stream"],
    ),
    # int fputws (const wchar_t *WS, FILE *STREAM);
    "fputws": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        ],
    ...
    "fputs_unlocked": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["s", "stream"],
    ),
    # int fputws_unlocked (const wchar_t *WS, FILE *STREAM);
    "fputws_unlocked": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        ],
    ...
    "putw": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["w", "stream"],
    ),
    # int fgetc (FILE *STREAM);
    "fgetc": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # wint_t fgetwc (FILE *STREAM);
    "fgetwc": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=False, label="wint_t"), arg_names=["stream"]
    ),
    # int fgetc_unlocked (FILE *STREAM);
    "fgetc_unlocked": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # wint_t fgetwc_unlocked (FILE *STREAM);
    "fgetwc_unlocked": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=False, label="wint_t"), arg_names=["stream"]
    ),
    # int getc (FILE *STREAM);
    "getc": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # wint_t getwc (FILE *STREAM);
    "getwc": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=False, label="wint_t"), arg_names=["stream"]
    ),
    # int getc_unlocked (FILE *STREAM);
    "getc_unlocked": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # wint_t getwc_unlocked (FILE *STREAM);
    "getwc_unlocked": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=False, label="wint_t"), arg_names=["stream"]
    ),
    # int getchar (void);
    ...
    "getw": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # ssize_t getline (char **LINEPTR, size_t *N, FILE *STREAM);
    "getline": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
            SimTypePointer(SimTypeLong(signed=False, label="size_t"), offset=0),
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        ...
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["lineptr", "n", "stream"],
    ),
    # ssize_t getdelim (char **LINEPTR, size_t *N, int DELIMITER, FILE *STREAM);
    "getdelim": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
            SimTypePointer(SimTypeLong(signed=False, label="size_t"), offset=0),
            SimTypeInt(signed=True),
        ...
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["lineptr", "n", "delimiter", "stream"],
    ),
    # char * gets (char *S);
    "gets": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["s"]
    ),
    # char * fgets (char *S, int COUNT, FILE *STREAM);
    "fgets": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        ...
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["s", "count", "stream"],
    ),
    # wchar_t * fgetws (wchar_t *WS, int COUNT, FILE *STREAM);
    "fgetws": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        ...
        SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        arg_names=["ws", "count", "stream"],
    ),
    # char * fgets_unlocked (char *S, int COUNT, FILE *STREAM);
    "fgets_unlocked": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
    ...
    "fgetws_unlocked": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
    ...
    "ungetc": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["c", "stream"],
    ),
    # wint_t ungetwc (wint_t WC, FILE *STREAM);
    "ungetwc": SimTypeFunction(
        [SimTypeInt(signed=False, label="wint_t"), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=False, label="wint_t"),
        arg_names=["wc", "stream"],
    ),
    # size_t fread (void *DATA, size_t SIZE, size_t COUNT, FILE *STREAM);
    "fread": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypeLong(signed=False, label="size_t"),
    ...
    "fwrite_unlocked": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypeLong(signed=False, label="size_t"),
    ...
    "printf": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["template"], variadic=True
    ),
    # int __printf_chk (int flag, const char *TEMPLATE, ...);
    "__printf_chk": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["flag", "template"],
        variadic=True,
    ),
    # int wprintf (const wchar_t *TEMPLATE, ...);
    "wprintf": SimTypeFunction(
        [SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["template"],
        variadic=True,
    ...
    "fprintf": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["stream", "template"],
        variadic=True,
    ),
    # int __fprintf_chk (int flag, FILE *STREAM, const char *TEMPLATE, ...);
    "__fprintf_chk": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
        ...
        SimTypeInt(signed=True),
        arg_names=["flag", "stream", "template"],
        variadic=True,
    ),
    # int fwprintf (FILE *STREAM, const wchar_t *TEMPLATE, ...);
    "fwprintf": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
    ...
    "sprintf": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["s", "template"],
        variadic=True,
    ),
    # int swprintf (wchar_t *WS, size_t SIZE, const wchar_t *TEMPLATE, ...);
    "swprintf": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ...
        SimTypeInt(signed=True),
        arg_names=["ws", "size", "template"],
        variadic=True,
    ),
    # int snprintf (char *S, size_t SIZE, const char *TEMPLATE, ...);
    "snprintf": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeChar(), offset=0),
        ...
        SimTypeInt(signed=True),
        arg_names=["s", "size", "template"],
        variadic=True,
    ),
    # int asprintf (char **PTR, const char *TEMPLATE, ...);
    "asprintf": SimTypeFunction(
        [SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["ptr", "template"],
        variadic=True,
    ),
    # int obstack_printf (struct obstack *OBSTACK, const char *TEMPLATE, ...);
    "obstack_printf": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["obstack"], offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["obstack", "template"],
        variadic=True,
    ),
    # int vprintf (const char *TEMPLATE, va_list AP);
    "vprintf": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeInt(signed=True),
        arg_names=["template", "ap"],
    ),
    # int vwprintf (const wchar_t *TEMPLATE, va_list AP);
    "vwprintf": SimTypeFunction(
        [SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0), ALL_TYPES["va_list"]],
        SimTypeInt(signed=True),
        arg_names=["template", "ap"],
    ),
    # int vfprintf (FILE *STREAM, const char *TEMPLATE, va_list AP);
    "vfprintf": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0), SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeInt(signed=True),
        arg_names=["stream", "template", "ap"],
    ),
    # int vfwprintf (FILE *STREAM, const wchar_t *TEMPLATE, va_list AP);
    "vfwprintf": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            ALL_TYPES["va_list"],
    ...
    "vsprintf": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeInt(signed=True),
        arg_names=["s", "template", "ap"],
    ),
    # int vswprintf (wchar_t *WS, size_t SIZE, const wchar_t *TEMPLATE, va_list AP);
    "vswprintf": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ...
        SimTypeInt(signed=True),
        arg_names=["ws", "size", "template", "ap"],
    ),
    # int vsnprintf (char *S, size_t SIZE, const char *TEMPLATE, va_list AP);
    "vsnprintf": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeChar(), offset=0),
        ...
        SimTypeInt(signed=True),
        arg_names=["s", "size", "template", "ap"],
    ),
    # int vasprintf (char **PTR, const char *TEMPLATE, va_list AP);
    "vasprintf": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            ALL_TYPES["va_list"],
        ...
        SimTypeInt(signed=True),
        arg_names=["ptr", "template", "ap"],
    ),
    # int obstack_vprintf (struct obstack *OBSTACK, const char *TEMPLATE, va_list AP);
    "obstack_vprintf": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["obstack"], offset=0), SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeInt(signed=True),
        arg_names=["obstack", "template", "ap"],
    ),
    # size_t parse_printf_format (const char *TEMPLATE, size_t N, int *ARGTYPES);
    "parse_printf_format": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeInt(signed=True), offset=0),
        ],
        SimTypeLong(signed=False, label="size_t"),
        arg_names=["template", "n", "argtypes"],
    ),
    ...
    "printf_size": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
            SimTypePointer(ALL_TYPES["printf_info"], offset=0),
            SimTypePointer(SimTypePointer(SimTypeBottom(label="void"), offset=0), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["fp", "info", "args"],
    ),
    # int printf_size_info (const struct printf_info *INFO, size_t N, int *ARGTYPES);
    "printf_size_info": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["printf_info"], offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeInt(signed=True), offset=0),
        ...
        SimTypeInt(signed=True),
        arg_names=["info", "n", "argtypes"],
    ),
    # int __isoc99_scanf (const char *TEMPLATE, ...);
    "__isoc99_scanf": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["template"], variadic=True
    ),
    # int scanf (const char *TEMPLATE, ...);
    "scanf": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["template"], variadic=True
    ),
    # int wscanf (const wchar_t *TEMPLATE, ...);
    "wscanf": SimTypeFunction(
        [SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["template"],
        variadic=True,
    ...
    "__isoc99_fscanf": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["stream", "template"],
        variadic=True,
    ...
    "__isoc99_sscanf": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["s", "template"],
        variadic=True,
    ...
    "swscanf": SimTypeFunction(
        [
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["ws", "template"],
        variadic=True,
    ),
    # int vscanf (const char *TEMPLATE, va_list AP);
    "vscanf": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeInt(signed=True),
        arg_names=["template", "ap"],
    ),
    # int vwscanf (const wchar_t *TEMPLATE, va_list AP);
    "vwscanf": SimTypeFunction(
        [SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0), ALL_TYPES["va_list"]],
        SimTypeInt(signed=True),
        arg_names=["template", "ap"],
    ),
    # int vfscanf (FILE *STREAM, const char *TEMPLATE, va_list AP);
    "vfscanf": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0), SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeInt(signed=True),
        arg_names=["stream", "template", "ap"],
    ),
    # int vfwscanf (FILE *STREAM, const wchar_t *TEMPLATE, va_list AP);
    "vfwscanf": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
            SimTypePointer(SimTypeShort(signed=False, label="wchar_t"), offset=0),
            ALL_TYPES["va_list"],
    ...
    "feof": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int feof_unlocked (FILE *STREAM);
    "feof_unlocked": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int ferror (FILE *STREAM);
    "ferror": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int ferror_unlocked (FILE *STREAM);
    "ferror_unlocked": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # void clearerr (FILE *STREAM);
    "clearerr": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeBottom(label="void"), arg_names=["stream"]
    ),
    # void clearerr_unlocked (FILE *STREAM);
    "clearerr_unlocked": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeBottom(label="void"), arg_names=["stream"]
    ),
    # long int ftell (FILE *STREAM);
    "ftell": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeLong(signed=True), arg_names=["stream"]
    ),
    # off_t ftello (FILE *STREAM);
    "ftello": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeLong(signed=False, label="off_t"), arg_names=["stream"]
    ),
    # off64_t ftello64 (FILE *STREAM);
    "ftello64": None,
    # int fseek (FILE *STREAM, long int OFFSET, int WHENCE);
    "fseek": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0), SimTypeLong(signed=True), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["stream", "offset", "whence"],
    ),
    # int fseeko (FILE *STREAM, off_t OFFSET, int WHENCE);
    "fseeko": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
            SimTypeLong(signed=False, label="off_t"),
            SimTypeInt(signed=True),
        ],
        SimTypeInt(signed=True),
        arg_names=["stream", "offset", "whence"],
    ...
    "fflush": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int fflush_unlocked (FILE *STREAM);
    "fflush_unlocked": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # void _flushlbf (void);
    "_flushlbf": SimTypeFunction([], SimTypeBottom(label="void")),
    # void __fpurge (FILE *STREAM);
    "__fpurge": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeBottom(label="void"), arg_names=["stream"]
    ),
    # int setvbuf (FILE *STREAM, char *BUF, int MODE, size_t SIZE);
    "setvbuf": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeInt(signed=True),
        ...
        SimTypeInt(signed=True),
        arg_names=["stream", "buf", "mode", "size"],
    ),
    # void setbuf (FILE *STREAM, char *BUF);
    "setbuf": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeBottom(label="void"),
        arg_names=["stream", "buf"],
    ),
    # void setbuffer (FILE *STREAM, char *BUF, size_t SIZE);
    "setbuffer": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
        ...
        SimTypeBottom(label="void"),
        arg_names=["stream", "buf", "size"],
    ),
    # void setlinebuf (FILE *STREAM);
    "setlinebuf": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeBottom(label="void"), arg_names=["stream"]
    ),
    # int __flbf (FILE *STREAM);
    "__flbf": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # size_t __fbufsize (FILE *STREAM);
    "__fbufsize": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeLong(signed=False, label="size_t"), arg_names=["stream"]
    ),
    # size_t __fpending (FILE *STREAM);
    "__fpending": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeLong(signed=False, label="size_t"), arg_names=["stream"]
    ),
    # FILE * fmemopen (void *BUF, size_t SIZE, const char *OPENTYPE);
    "fmemopen": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeChar(), offset=0),
        ...
        SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        arg_names=["buf", "size", "opentype"],
    ),
    # FILE * open_memstream (char **PTR, size_t *SIZELOC);
    "open_memstream": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
            SimTypePointer(SimTypeLong(signed=False, label="size_t"), offset=0),
        ],
        SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        arg_names=["ptr", "sizeloc"],
    ),
    ...
    "fmtmsg": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["classification", "label", "severity", "text", "action", "tag"],
    ),
    # int addseverity (int SEVERITY, const char *STRING);
    "addseverity": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["severity", "string"],
    ),
    # int open (const char *FILENAME, int FLAGS, mode_t MODE);
    "open": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True), SimTypeShort(signed=False, label="mode_t")],
        SimTypeInt(signed=True),
        arg_names=["filename", "flags", "mode"],
    ),
    # int open64 (const char *FILENAME, int FLAGS, mode_t MODE);
    "open64": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True), SimTypeShort(signed=False, label="mode_t")],
        SimTypeInt(signed=True),
        arg_names=["filename", "flags", "mode"],
    ),
    ...
    "read": SimTypeFunction(
        ...
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["filedes", "buffer", "size"],
    ),
    # ssize_t pread (int FILEDES, void *BUFFER, size_t SIZE, off_t OFFSET);
    "pread": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
    ...
    "preadv": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["iovec"], offset=0),
            SimTypeInt(signed=True),
            SimTypeLong(signed=False, label="off_t"),
        ],
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["fd", "iov", "iovcnt", "offset"],
    ),
    # ssize_t preadv64 (int FD, const struct iovec *IOV, int IOVCNT, off64_t OFFSET);
    "preadv64": None,
    # ssize_t pwritev (int FD, const struct iovec *IOV, int IOVCNT, off_t OFFSET);
    "pwritev": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["iovec"], offset=0),
            SimTypeInt(signed=True),
    ...
    "lseek": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeLong(signed=False, label="off_t"), SimTypeInt(signed=True)],
        SimTypeLong(signed=False, label="off_t"),
        arg_names=["filedes", "offset", "whence"],
    ),
    # off64_t lseek64 (int FILEDES, off64_t OFFSET, int WHENCE);
    "lseek64": None,
    # FILE * fdopen (int FILEDES, const char *OPENTYPE);
    "fdopen": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        arg_names=["filedes", "opentype"],
    ),
    # int fileno (FILE *STREAM);
    "fileno": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int fileno_unlocked (FILE *STREAM);
    "fileno_unlocked": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # ssize_t readv (int FILEDES, const struct iovec *VECTOR, int COUNT);
    "readv": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["iovec"], offset=0), SimTypeInt(signed=True)],
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["filedes", "vector", "count"],
    ),
    # ssize_t writev (int FILEDES, const struct iovec *VECTOR, int COUNT);
    "writev": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["iovec"], offset=0), SimTypeInt(signed=True)],
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["filedes", "vector", "count"],
    ),
    # void * mmap (void *ADDRESS, size_t LENGTH, int PROTECT, int FLAGS, int FILEDES, off_t OFFSET);
    "mmap": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypeInt(signed=True),
        ...
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["address", "length", "protect", "flags", "filedes", "offset"],
    ),
    # void * mmap64 (void *ADDRESS, size_t LENGTH, int PROTECT, int FLAGS, int FILEDES, off64_t OFFSET);
    "mmap64": None,
    # int munmap (void *ADDR, size_t LENGTH);
    "munmap": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["addr", "length"],
    ),
    # int msync (void *ADDRESS, size_t LENGTH, int FLAGS);
    "msync": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypeInt(signed=True),
        ...
        SimTypeInt(signed=True),
        arg_names=["address", "length", "flags"],
    ),
    # void * mremap (void *ADDRESS, size_t LENGTH, size_t NEW_LENGTH, int FLAG);
    "mremap": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypeLong(signed=False, label="size_t"),
        ...
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["address", "length", "new_length", "flag"],
    ),
    # int madvise (void *ADDR, size_t LENGTH, int ADVICE);
    "madvise": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypeInt(signed=True),
        ...
        SimTypeInt(signed=True),
        arg_names=["addr", "length", "advice"],
    ),
    # int shm_open (const char *NAME, int OFLAG, mode_t MODE);
    "shm_open": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True), SimTypeShort(signed=False, label="mode_t")],
        SimTypeInt(signed=True),
        arg_names=["name", "oflag", "mode"],
    ),
    # int shm_unlink (const char *NAME);
    "shm_unlink": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["name"]
    ),
    ...
    "select": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["nfds", "read_fds", "write_fds", "except_fds", "timeout"],
    ),
    # void sync (void);
    ...
    "aio_read": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["aiocb"], offset=0)], SimTypeInt(signed=True), arg_names=["aiocbp"]
    ),
    # int aio_read64 (struct aiocb64 *AIOCBP);
    "aio_read64": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["aiocb64"], offset=0)], SimTypeInt(signed=True), arg_names=["aiocbp"]
    ),
    # int aio_write (struct aiocb *AIOCBP);
    "aio_write": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["aiocb"], offset=0)], SimTypeInt(signed=True), arg_names=["aiocbp"]
    ),
    # int aio_write64 (struct aiocb64 *AIOCBP);
    "aio_write64": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["aiocb64"], offset=0)], SimTypeInt(signed=True), arg_names=["aiocbp"]
    ),
    # int lio_listio (int MODE, struct aiocb *const LIST[], int NENT, struct sigevent *SIG);
    "lio_listio": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypeFixedSizeArray(SimTypePointer(ALL_TYPES["aiocb"], offset=0), 0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["sigevent"], offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["mode", "list", "nent", "sig"],
    ),
    # int lio_listio64 (int MODE, struct aiocb64 *const LIST[], int NENT, struct sigevent *SIG);
    "lio_listio64": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypeFixedSizeArray(SimTypePointer(ALL_TYPES["aiocb64"], offset=0), 0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["sigevent"], offset=0),
        ],
        SimTypeInt(signed=True),
    ...
    "aio_error": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["aiocb"], offset=0)], SimTypeInt(signed=True), arg_names=["aiocbp"]
    ),
    # int aio_error64 (const struct aiocb64 *AIOCBP);
    "aio_error64": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["aiocb64"], offset=0)], SimTypeInt(signed=True), arg_names=["aiocbp"]
    ),
    # ssize_t aio_return (struct aiocb *AIOCBP);
    "aio_return": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["aiocb"], offset=0)], SimTypeLong(signed=True, label="ssize_t"), arg_names=["aiocbp"]
    ),
    # ssize_t aio_return64 (struct aiocb64 *AIOCBP);
    "aio_return64": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["aiocb64"], offset=0)],
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["aiocbp"],
    ),
    # int aio_fsync (int OP, struct aiocb *AIOCBP);
    "aio_fsync": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["aiocb"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["op", "aiocbp"],
    ),
    # int aio_fsync64 (int OP, struct aiocb64 *AIOCBP);
    "aio_fsync64": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["aiocb64"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["op", "aiocbp"],
    ),
    # int aio_suspend (const struct aiocb *const LIST[], int NENT, const struct timespec *TIMEOUT);
    "aio_suspend": SimTypeFunction(
        [
            SimTypeFixedSizeArray(SimTypePointer(ALL_TYPES["aiocb"], offset=0), 0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["timespec"], offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["list", "nent", "timeout"],
    ),
    # int aio_suspend64 (const struct aiocb64 *const LIST[], int NENT, const struct timespec *TIMEOUT);
    "aio_suspend64": SimTypeFunction(
        [
            SimTypeFixedSizeArray(SimTypePointer(ALL_TYPES["aiocb64"], offset=0), 0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["timespec"], offset=0),
    ...
    "aio_cancel": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["aiocb"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["fildes", "aiocbp"],
    ),
    # int aio_cancel64 (int FILDES, struct aiocb64 *AIOCBP);
    "aio_cancel64": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["aiocb64"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["fildes", "aiocbp"],
    ),
    # void aio_init (const struct aioinit *INIT);
    "aio_init": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["aioinit"], offset=0)], SimTypeBottom(label="void"), arg_names=["init"]
    ),
    # int fcntl (int FILEDES, int COMMAND, ...);
    "fcntl": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["filedes", "command"],
        variadic=True,
    ),
    # int dup (int OLD);
    "dup": SimTypeFunction([SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["old"]),
    # int dup2 (int OLD, int NEW);
    "dup2": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["old", "new"]
    ),
    # int ioctl (int FILEDES, int COMMAND, ...);
    "ioctl": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["filedes", "command"],
        variadic=True,
    ...
    "getcwd": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["buffer", "size"],
    ),
    # char * get_current_dir_name (void);
    "get_current_dir_name": SimTypeFunction([], SimTypePointer(SimTypeChar(), offset=0)),
    # int chdir (const char *FILENAME);
    "chdir": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["filename"]
    ),
    # int fchdir (int FILEDES);
    "fchdir": SimTypeFunction([SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["filedes"]),
    # int IFTODT (mode_t MODE);
    "IFTODT": SimTypeFunction(
        [SimTypeShort(signed=False, label="mode_t")], SimTypeInt(signed=True), arg_names=["mode"]
    ),
    # mode_t DTTOIF (int DTYPE);
    "DTTOIF": SimTypeFunction(
        [SimTypeInt(signed=True)], SimTypeShort(signed=False, label="mode_t"), arg_names=["dtype"]
    ),
    ...
    "alphasort": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(ALL_TYPES["dirent"], offset=0), offset=0),
            SimTypePointer(SimTypePointer(ALL_TYPES["dirent"], offset=0), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["a", "b"],
    ...
    "alphasort64": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(ALL_TYPES["dirent64"], offset=0), offset=0),
            SimTypePointer(SimTypePointer(ALL_TYPES["dirent"], offset=0), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["a", "b"],
    ...
    "link": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["oldname", "newname"],
    ),
    # int symlink (const char *OLDNAME, const char *NEWNAME);
    "symlink": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["oldname", "newname"],
    ),
    # ssize_t readlink (const char *FILENAME, char *BUFFER, size_t SIZE);
    "readlink": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
        ...
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["filename", "buffer", "size"],
    ),
    # char * canonicalize_file_name (const char *NAME);
    "canonicalize_file_name": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["name"]
    ),
    # char * realpath (const char *restrict NAME, char *restrict RESOLVED);
    "realpath": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["name", "resolved"],
    ),
    # int unlink (const char *FILENAME);
    "unlink": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["filename"]
    ),
    # int rmdir (const char *FILENAME);
    "rmdir": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["filename"]
    ),
    # int remove (const char *FILENAME);
    "remove": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["filename"]
    ),
    # int rename (const char *OLDNAME, const char *NEWNAME);
    "rename": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["oldname", "newname"],
    ),
    # int mkdir (const char *FILENAME, mode_t MODE);
    "mkdir": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeShort(signed=False, label="mode_t")],
        SimTypeInt(signed=True),
        arg_names=["filename", "mode"],
    ),
    # int stat (const char *FILENAME, struct stat *BUF);
    "stat": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["stat"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filename", "buf"],
    ),
    # int stat64 (const char *FILENAME, struct stat64 *BUF);
    "stat64": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["stat64"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filename", "buf"],
    ),
    # int fstat (int FILEDES, struct stat *BUF);
    "fstat": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["stat"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filedes", "buf"],
    ),
    # int fstat64 (int FILEDES, struct stat64 *BUF);
    "fstat64": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["stat64"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filedes", "buf"],
    ),
    # int lstat (const char *FILENAME, struct stat *BUF);
    "lstat": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["stat"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filename", "buf"],
    ),
    # int lstat64 (const char *FILENAME, struct stat64 *BUF);
    "lstat64": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["stat64"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filename", "buf"],
    ),
    # int chown (const char *FILENAME, uid_t OWNER, gid_t GROUP);
    "chown": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeInt(signed=False, label="uid_t"),
            SimTypeInt(signed=False, label="gid_t"),
        ],
        SimTypeInt(signed=True),
        arg_names=["filename", "owner", "group"],
    ),
    # int fchown (int FILEDES, uid_t OWNER, gid_t GROUP);
    "fchown": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=False, label="uid_t"), SimTypeInt(signed=False, label="gid_t")],
        SimTypeInt(signed=True),
        arg_names=["filedes", "owner", "group"],
    ),
    # mode_t umask (mode_t MASK);
    "umask": SimTypeFunction(
        [SimTypeShort(signed=False, label="mode_t")], SimTypeShort(signed=False, label="mode_t"), arg_names=["mask"]
    ),
    # mode_t getumask (void);
    "getumask": SimTypeFunction([], SimTypeShort(signed=False, label="mode_t")),
    # int chmod (const char *FILENAME, mode_t MODE);
    "chmod": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeShort(signed=False, label="mode_t")],
        SimTypeInt(signed=True),
        arg_names=["filename", "mode"],
    ),
    # int fchmod (int FILEDES, mode_t MODE);
    "fchmod": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeShort(signed=False, label="mode_t")],
        SimTypeInt(signed=True),
        arg_names=["filedes", "mode"],
    ),
    # int access (const char *FILENAME, int HOW);
    "access": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["filename", "how"],
    ),
    # int utime (const char *FILENAME, const struct utimbuf *TIMES);
    "utime": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["utimbuf"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filename", "times"],
    ),
    # int utimes (const char *FILENAME, const struct timeval TVP[2]);
    "utimes": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeFixedSizeArray(ALL_TYPES["timeval"], 2)],
        SimTypeInt(signed=True),
        arg_names=["filename", "tvp"],
    ),
    # int lutimes (const char *FILENAME, const struct timeval TVP[2]);
    "lutimes": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeFixedSizeArray(ALL_TYPES["timeval"], 2)],
        SimTypeInt(signed=True),
        arg_names=["filename", "tvp"],
    ),
    # int futimes (int FD, const struct timeval TVP[2]);
    "futimes": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeFixedSizeArray(ALL_TYPES["timeval"], 2)],
        SimTypeInt(signed=True),
        arg_names=["fd", "tvp"],
    ),
    # int truncate (const char *FILENAME, off_t LENGTH);
    "truncate": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="off_t")],
        SimTypeInt(signed=True),
        arg_names=["filename", "length"],
    ),
    # int truncate64 (const char *NAME, off64_t LENGTH);
    "truncate64": None,
    # int ftruncate (int FD, off_t LENGTH);
    "ftruncate": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeLong(signed=False, label="off_t")],
        SimTypeInt(signed=True),
        arg_names=["fd", "length"],
    ),
    ...
    "posix_fallocate": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeLong(signed=False, label="off_t"), SimTypeLong(signed=False, label="off_t")],
        SimTypeInt(signed=True),
        arg_names=["fd", "offset", "length"],
    ),
    ...
    "tmpnam": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["result"]
    ),
    # char * tmpnam_r (char *RESULT);
    "tmpnam_r": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["result"]
    ),
    # char * tempnam (const char *DIR, const char *PREFIX);
    "tempnam": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["dir", "prefix"],
    ),
    # char * mktemp (char *TEMPLATE);
    "mktemp": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["template"]
    ),
    # int mkstemp (char *TEMPLATE);
    "mkstemp": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["template"]
    ),
    # char * mkdtemp (char *TEMPLATE);
    "mkdtemp": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["template"]
    ),
    # int pipe (int FILEDES[2]);
    "pipe": SimTypeFunction(
        [SimTypeFixedSizeArray(SimTypeInt(signed=True), 2)], SimTypeInt(signed=True), arg_names=["filedes"]
    ),
    # FILE * popen (const char *COMMAND, const char *MODE);
    "popen": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        arg_names=["command", "mode"],
    ),
    # int pclose (FILE *STREAM);
    "pclose": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # int mkfifo (const char *FILENAME, mode_t MODE);
    "mkfifo": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeShort(signed=False, label="mode_t")],
        SimTypeInt(signed=True),
        arg_names=["filename", "mode"],
    ),
    ...
    "bind": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["sockaddr"], offset=0),
            SimTypeInt(signed=True, label="socklen_t"),
        ],
        SimTypeInt(signed=True),
        arg_names=["socket", "addr", "length"],
    ),
    # int getsockname (int SOCKET, struct sockaddr *ADDR, socklen_t *LENGTH_PTR);
    "getsockname": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["sockaddr"], offset=0),
            SimTypePointer(SimTypeInt(signed=True, label="socklen_t"), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["socket", "addr", "length_ptr"],
    ),
    # unsigned int if_nametoindex (const char *IFNAME);
    "if_nametoindex": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=False), arg_names=["ifname"]
    ),
    # char * if_indextoname (unsigned int IFINDEX, char *IFNAME);
    "if_indextoname": SimTypeFunction(
        [SimTypeInt(signed=False), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["ifindex", "ifname"],
    ),
    # struct if_nameindex * if_nameindex (void);
    "if_nameindex": SimTypeFunction([], SimTypePointer(ALL_TYPES["if_nameindex"], offset=0)),
    # void if_freenameindex (struct if_nameindex *PTR);
    "if_freenameindex": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["if_nameindex"], offset=0)], SimTypeBottom(label="void"), arg_names=["ptr"]
    ),
    # int inet_aton (const char *NAME, struct in_addr *ADDR);
    "inet_aton": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["in_addr"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["name", "addr"],
    ),
    # uint32_t inet_addr (const char *NAME);
    "inet_addr": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=False, label="uint32_t"), arg_names=["name"]
    ),
    # uint32_t inet_network (const char *NAME);
    "inet_network": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=False, label="uint32_t"), arg_names=["name"]
    ),
    # char * inet_ntoa (struct in_addr ADDR);
    "inet_ntoa": SimTypeFunction([ALL_TYPES["in_addr"]], SimTypePointer(SimTypeChar(), offset=0), arg_names=["addr"]),
    # struct in_addr inet_makeaddr (uint32_t NET, uint32_t LOCAL);
    "inet_makeaddr": SimTypeFunction(
        [SimTypeInt(signed=False, label="uint32_t"), SimTypeInt(signed=False, label="uint32_t")],
        ALL_TYPES["in_addr"],
        arg_names=["net", "local"],
    ),
    # uint32_t inet_lnaof (struct in_addr ADDR);
    "inet_lnaof": SimTypeFunction(
        [ALL_TYPES["in_addr"]], SimTypeInt(signed=False, label="uint32_t"), arg_names=["addr"]
    ),
    # uint32_t inet_netof (struct in_addr ADDR);
    "inet_netof": SimTypeFunction(
        [ALL_TYPES["in_addr"]], SimTypeInt(signed=False, label="uint32_t"), arg_names=["addr"]
    ),
    # int inet_pton (int AF, const char *CP, void *BUF);
    "inet_pton": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
    ...
    "inet_ntop": SimTypeFunction(
        ...
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["af", "cp", "buf", "len"],
    ),
    # struct hostent * gethostbyname (const char *NAME);
    "gethostbyname": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(ALL_TYPES["hostent"], offset=0), arg_names=["name"]
    ),
    # struct hostent * gethostbyname2 (const char *NAME, int AF);
    "gethostbyname2": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypePointer(ALL_TYPES["hostent"], offset=0),
        arg_names=["name", "af"],
    ),
    # struct hostent * gethostbyaddr (const void *ADDR, socklen_t LENGTH, int FORMAT);
    "gethostbyaddr": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeInt(signed=True, label="socklen_t"),
            SimTypeInt(signed=True),
    ...
    "gethostbyname_r": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(ALL_TYPES["hostent"], offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypePointer(ALL_TYPES["hostent"], offset=0), offset=0),
            SimTypePointer(SimTypeInt(signed=True), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["name", "result_buf", "buf", "buflen", "result", "h_errnop"],
    ),
    ...
    "gethostbyname2_r": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["hostent"], offset=0),
        ...
        SimTypeInt(signed=True),
        arg_names=["name", "af", "result_buf", "buf", "buflen", "result", "h_errnop"],
    ),
    ...
    "gethostbyaddr_r": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeInt(signed=True, label="socklen_t"),
            SimTypeInt(signed=True),
        ...
        SimTypeInt(signed=True),
        arg_names=["addr", "length", "format", "result_buf", "buf", "buflen", "result", "h_errnop"],
    ),
    ...
    "getservbyname": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(ALL_TYPES["servent"], offset=0),
        arg_names=["name", "proto"],
    ),
    # struct servent * getservbyport (int PORT, const char *PROTO);
    "getservbyport": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(ALL_TYPES["servent"], offset=0),
    ...
    "htons": SimTypeFunction(
        [SimTypeShort(signed=False, label="uint16_t")],
        SimTypeShort(signed=False, label="uint16_t"),
        arg_names=["hostshort"],
    ),
    # uint16_t ntohs (uint16_t NETSHORT);
    "ntohs": SimTypeFunction(
        [SimTypeShort(signed=False, label="uint16_t")],
        SimTypeShort(signed=False, label="uint16_t"),
        arg_names=["netshort"],
    ),
    # uint32_t htonl (uint32_t HOSTLONG);
    "htonl": SimTypeFunction(
        [SimTypeInt(signed=False, label="uint32_t")], SimTypeInt(signed=False, label="uint32_t"), arg_names=["hostlong"]
    ),
    # uint32_t ntohl (uint32_t NETLONG);
    "ntohl": SimTypeFunction(
        [SimTypeInt(signed=False, label="uint32_t")], SimTypeInt(signed=False, label="uint32_t"), arg_names=["netlong"]
    ),
    # struct protoent * getprotobyname (const char *NAME);
    "getprotobyname": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(ALL_TYPES["protoent"], offset=0), arg_names=["name"]
    ),
    # struct protoent * getprotobynumber (int PROTOCOL);
    "getprotobynumber": SimTypeFunction(
        [SimTypeInt(signed=True)], SimTypePointer(ALL_TYPES["protoent"], offset=0), arg_names=["protocol"]
    ),
    ...
    "socket": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["namespace", "style", "protocol"],
    ),
    # int shutdown (int SOCKET, int HOW);
    "shutdown": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["socket", "how"]
    ),
    # int socketpair (int NAMESPACE, int STYLE, int PROTOCOL, int FILEDES[2]);
    "socketpair": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypeInt(signed=True),
            SimTypeInt(signed=True),
            SimTypeFixedSizeArray(SimTypeInt(signed=True), 2),
        ],
        SimTypeInt(signed=True),
        arg_names=["namespace", "style", "protocol", "filedes"],
    ),
    # int connect (int SOCKET, struct sockaddr *ADDR, socklen_t LENGTH);
    "connect": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["sockaddr"], offset=0),
            SimTypeInt(signed=True, label="socklen_t"),
    ...
    "listen": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["socket", "n"]
    ),
    # int accept (int SOCKET, struct sockaddr *ADDR, socklen_t *LENGTH_PTR);
    "accept": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["sockaddr"], offset=0),
            SimTypePointer(SimTypeInt(signed=True, label="socklen_t"), offset=0),
    ...
    "send": SimTypeFunction(
        ...
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["socket", "buffer", "size", "flags"],
    ),
    # ssize_t recv (int SOCKET, void *BUFFER, size_t SIZE, int FLAGS);
    "recv": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
    ...
    "getsockopt": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["socket", "level", "optname", "optval", "optlen_ptr"],
    ),
    # int setsockopt (int SOCKET, int LEVEL, int OPTNAME, const void *OPTVAL, socklen_t OPTLEN);
    "setsockopt": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypeInt(signed=True),
            SimTypeInt(signed=True),
        ...
        SimTypeInt(signed=True),
        arg_names=["socket", "level", "optname", "optval", "optlen"],
    ),
    # struct netent * getnetbyname (const char *NAME);
    "getnetbyname": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(ALL_TYPES["netent"], offset=0), arg_names=["name"]
    ),
    # struct netent * getnetbyaddr (uint32_t NET, int TYPE);
    "getnetbyaddr": SimTypeFunction(
        [SimTypeInt(signed=False, label="uint32_t"), SimTypeInt(signed=True)],
        SimTypePointer(ALL_TYPES["netent"], offset=0),
        arg_names=["net", "type"],
    ),
    ...
    "ttyname": SimTypeFunction(
        [SimTypeInt(signed=True)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["filedes"]
    ),
    # int ttyname_r (int FILEDES, char *BUF, size_t LEN);
    "ttyname_r": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["filedes", "buf", "len"],
    ),
    # int tcgetattr (int FILEDES, struct termios *TERMIOS_P);
    "tcgetattr": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["termios"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filedes", "termios_p"],
    ),
    # int tcsetattr (int FILEDES, int WHEN, const struct termios *TERMIOS_P);
    "tcsetattr": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["termios"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filedes", "when", "termios_p"],
    ),
    # speed_t cfgetospeed (const struct termios *TERMIOS_P);
    "cfgetospeed": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["termios"], offset=0)],
        SimTypeInt(signed=False, label="speed_t"),
        arg_names=["termios_p"],
    ),
    # speed_t cfgetispeed (const struct termios *TERMIOS_P);
    "cfgetispeed": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["termios"], offset=0)],
        SimTypeInt(signed=False, label="speed_t"),
        arg_names=["termios_p"],
    ),
    # int cfsetospeed (struct termios *TERMIOS_P, speed_t SPEED);
    "cfsetospeed": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["termios"], offset=0), SimTypeInt(signed=False, label="speed_t")],
        SimTypeInt(signed=True),
        arg_names=["termios_p", "speed"],
    ),
    # int cfsetispeed (struct termios *TERMIOS_P, speed_t SPEED);
    "cfsetispeed": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["termios"], offset=0), SimTypeInt(signed=False, label="speed_t")],
        SimTypeInt(signed=True),
        arg_names=["termios_p", "speed"],
    ),
    # int cfsetspeed (struct termios *TERMIOS_P, speed_t SPEED);
    "cfsetspeed": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["termios"], offset=0), SimTypeInt(signed=False, label="speed_t")],
        SimTypeInt(signed=True),
        arg_names=["termios_p", "speed"],
    ),
    # void cfmakeraw (struct termios *TERMIOS_P);
    "cfmakeraw": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["termios"], offset=0)], SimTypeBottom(label="void"), arg_names=["termios_p"]
    ),
    # int gtty (int FILEDES, struct sgttyb *ATTRIBUTES);
    "gtty": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["sgttyb"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filedes", "attributes"],
    ),
    # int stty (int FILEDES, const struct sgttyb *ATTRIBUTES);
    "stty": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["sgttyb"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filedes", "attributes"],
    ),
    # int tcsendbreak (int FILEDES, int DURATION);
    "tcsendbreak": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["filedes", "duration"]
    ),
    # int tcdrain (int FILEDES);
    "tcdrain": SimTypeFunction([SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["filedes"]),
    # int tcflush (int FILEDES, int QUEUE);
    "tcflush": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["filedes", "queue"]
    ),
    # int tcflow (int FILEDES, int ACTION);
    "tcflow": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["filedes", "action"]
    ),
    # int getpt (void);
    ...
    "ptsname": SimTypeFunction(
        [SimTypeInt(signed=True)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["filedes"]
    ),
    # int ptsname_r (int FILEDES, char *BUF, size_t LEN);
    "ptsname_r": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["filedes", "buf", "len"],
    ),
    # int openpty (int *AMASTER, int *ASLAVE, char *NAME, const struct termios *TERMP, const struct winsize *WINP);
    "openpty": SimTypeFunction(
        [
            SimTypePointer(SimTypeInt(signed=True), offset=0),
            SimTypePointer(SimTypeInt(signed=True), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(ALL_TYPES["termios"], offset=0),
            SimTypePointer(ALL_TYPES["winsize"], offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["amaster", "aslave", "name", "termp", "winp"],
    ),
    # int forkpty (int *AMASTER, char *NAME, const struct termios *TERMP, const struct winsize *WINP);
    "forkpty": SimTypeFunction(
        [
            SimTypePointer(SimTypeInt(signed=True), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(ALL_TYPES["termios"], offset=0),
    ...
    "openlog": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True), SimTypeInt(signed=True)],
        SimTypeBottom(label="void"),
        arg_names=["ident", "option", "facility"],
    ),
    # void syslog (int FACILITY_PRIORITY, const char *FORMAT, ...);
    "syslog": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeBottom(label="void"),
        arg_names=["facility_priority", "format"],
        variadic=True,
    ),
    # void vsyslog (int FACILITY_PRIORITY, const char *FORMAT, va_list ARGLIST);
    "vsyslog": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0), ALL_TYPES["va_list"]],
        SimTypeBottom(label="void"),
        arg_names=["facility_priority", "format", "arglist"],
    ),
    # void closelog (void);
    ...
    "sincos": SimTypeFunction(
        [
            SimTypeDouble(align_double=True),
            SimTypePointer(SimTypeDouble(align_double=True), offset=0),
            SimTypePointer(SimTypeDouble(align_double=True), offset=0),
        ],
        SimTypeBottom(label="void"),
        arg_names=["x", "sinx", "cosx"],
    ),
    # void sincosf (float X, float *SINX, float *COSX);
    "sincosf": SimTypeFunction(
        [
            SimTypeFloat(size=32),
            SimTypePointer(SimTypeFloat(size=32), offset=0),
            SimTypePointer(SimTypeFloat(size=32), offset=0),
        ],
        SimTypeBottom(label="void"),
        arg_names=["x", "sinx", "cosx"],
    ...
    "atan2": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["y", "x"],
    ),
    # float atan2f (float Y, float X);
    "atan2f": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["y", "x"]
    ),
    # long double atan2l (long double Y, long double X);
    "atan2l": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["y", "x"],
    ),
    ...
    "powf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["base", "power"]
    ),
    # long double powl (long double BASE, long double POWER);
    "powl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["base", "power"],
    ),
    ...
    "hypot": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    # float hypotf (float X, float Y);
    "hypotf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["x", "y"]
    ),
    # long double hypotl (long double X, long double Y);
    "hypotl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    ...
    "lgamma_r": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypePointer(SimTypeInt(signed=True), offset=0)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "signp"],
    ),
    # float lgammaf_r (float X, int *SIGNP);
    "lgammaf_r": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypePointer(SimTypeInt(signed=True), offset=0)],
        SimTypeFloat(size=32),
        arg_names=["x", "signp"],
    ),
    # long double lgammal_r (long double X, int *SIGNP);
    "lgammal_r": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypePointer(SimTypeInt(signed=True), offset=0)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "signp"],
    ),
    ...
    "jn": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["n", "x"],
    ),
    # float jnf (int N, float X);
    "jnf": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["n", "x"]
    ),
    ...
    "rand_r": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=False), offset=0)], SimTypeInt(signed=True), arg_names=["seed"]
    ),
    ...
    "initstate": SimTypeFunction(
        [SimTypeInt(signed=False), SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["seed", "state", "size"],
    ),
    # char * setstate (char *STATE);
    "setstate": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["state"]
    ),
    # int random_r (struct random_data *restrict BUF, int32_t *restrict RESULT);
    "random_r": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["random_data"], offset=0),
            SimTypePointer(SimTypeInt(signed=True, label="int32_t"), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["buf", "result"],
    ),
    # int srandom_r (unsigned int SEED, struct random_data *BUF);
    "srandom_r": SimTypeFunction(
        [SimTypeInt(signed=False), SimTypePointer(ALL_TYPES["random_data"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["seed", "buf"],
    ),
    # int initstate_r (unsigned int SEED, char *restrict STATEBUF, size_t STATELEN, struct random_data *restrict BUF);
    "initstate_r": SimTypeFunction(
        [
            SimTypeInt(signed=False),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
        ...
        SimTypeInt(signed=True),
        arg_names=["seed", "statebuf", "statelen", "buf"],
    ),
    # int setstate_r (char *restrict STATEBUF, struct random_data *restrict BUF);
    "setstate_r": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["random_data"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["statebuf", "buf"],
    ),
    # double drand48 (void);
    "drand48": SimTypeFunction([], SimTypeDouble(align_double=True)),
    # double erand48 (unsigned short int XSUBI[3]);
    "erand48": SimTypeFunction(
        [SimTypeFixedSizeArray(SimTypeShort(signed=False), 3)], SimTypeDouble(align_double=True), arg_names=["xsubi"]
    ),
    # long int lrand48 (void);
    "lrand48": SimTypeFunction([], SimTypeLong(signed=True)),
    # long int nrand48 (unsigned short int XSUBI[3]);
    "nrand48": SimTypeFunction(
        [SimTypeFixedSizeArray(SimTypeShort(signed=False), 3)], SimTypeLong(signed=True), arg_names=["xsubi"]
    ),
    # long int mrand48 (void);
    "mrand48": SimTypeFunction([], SimTypeLong(signed=True)),
    # long int jrand48 (unsigned short int XSUBI[3]);
    "jrand48": SimTypeFunction(
        [SimTypeFixedSizeArray(SimTypeShort(signed=False), 3)], SimTypeLong(signed=True), arg_names=["xsubi"]
    ),
    # void srand48 (long int SEEDVAL);
    "srand48": SimTypeFunction([SimTypeLong(signed=True)], SimTypeBottom(label="void"), arg_names=["seedval"]),
    # unsigned short int * seed48 (unsigned short int SEED16V[3]);
    "seed48": SimTypeFunction(
        [SimTypeFixedSizeArray(SimTypeShort(signed=False), 3)],
        SimTypePointer(SimTypeShort(signed=False), offset=0),
        arg_names=["seed16v"],
    ),
    # void lcong48 (unsigned short int PARAM[7]);
    "lcong48": SimTypeFunction(
        [SimTypeFixedSizeArray(SimTypeShort(signed=False), 7)], SimTypeBottom(label="void"), arg_names=["param"]
    ),
    # int drand48_r (struct drand48_data *BUFFER, double *RESULT);
    "drand48_r": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["drand48_data"], offset=0),
            SimTypePointer(SimTypeDouble(align_double=True), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["buffer", "result"],
    ),
    # int erand48_r (unsigned short int XSUBI[3], struct drand48_data *BUFFER, double *RESULT);
    "erand48_r": SimTypeFunction(
        [
            SimTypeFixedSizeArray(SimTypeShort(signed=False), 3),
            SimTypePointer(ALL_TYPES["drand48_data"], offset=0),
            SimTypePointer(SimTypeDouble(align_double=True), offset=0),
        ...
        SimTypeInt(signed=True),
        arg_names=["xsubi", "buffer", "result"],
    ),
    # int lrand48_r (struct drand48_data *BUFFER, long int *RESULT);
    "lrand48_r": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["drand48_data"], offset=0), SimTypePointer(SimTypeLong(signed=True), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["buffer", "result"],
    ),
    # int nrand48_r (unsigned short int XSUBI[3], struct drand48_data *BUFFER, long int *RESULT);
    "nrand48_r": SimTypeFunction(
        [
            SimTypeFixedSizeArray(SimTypeShort(signed=False), 3),
            SimTypePointer(ALL_TYPES["drand48_data"], offset=0),
            SimTypePointer(SimTypeLong(signed=True), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["xsubi", "buffer", "result"],
    ),
    # int mrand48_r (struct drand48_data *BUFFER, long int *RESULT);
    "mrand48_r": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["drand48_data"], offset=0), SimTypePointer(SimTypeLong(signed=True), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["buffer", "result"],
    ),
    # int jrand48_r (unsigned short int XSUBI[3], struct drand48_data *BUFFER, long int *RESULT);
    "jrand48_r": SimTypeFunction(
        [
            SimTypeFixedSizeArray(SimTypeShort(signed=False), 3),
            SimTypePointer(ALL_TYPES["drand48_data"], offset=0),
            SimTypePointer(SimTypeLong(signed=True), offset=0),
    ...
    "srand48_r": SimTypeFunction(
        [SimTypeLong(signed=True), SimTypePointer(ALL_TYPES["drand48_data"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["seedval", "buffer"],
    ),
    # int seed48_r (unsigned short int SEED16V[3], struct drand48_data *BUFFER);
    "seed48_r": SimTypeFunction(
        [SimTypeFixedSizeArray(SimTypeShort(signed=False), 3), SimTypePointer(ALL_TYPES["drand48_data"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["seed16v", "buffer"],
    ),
    # int lcong48_r (unsigned short int PARAM[7], struct drand48_data *BUFFER);
    "lcong48_r": SimTypeFunction(
        [SimTypeFixedSizeArray(SimTypeShort(signed=False), 7), SimTypePointer(ALL_TYPES["drand48_data"], offset=0)],
        SimTypeInt(signed=True),
    ...
    "imaxabs": SimTypeFunction(
        [SimTypeInt(signed=True, label="intmax_t")], SimTypeInt(signed=True, label="intmax_t"), arg_names=["number"]
    ),
    ...
    "fabsl": SimTypeFunction(
        [SimTypeDouble(align_double=True)], SimTypeDouble(align_double=True), arg_names=["number"]
    ),
    ...
    "frexp": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypePointer(SimTypeInt(signed=True), offset=0)],
        SimTypeDouble(align_double=True),
        arg_names=["value", "exponent"],
    ),
    # float frexpf (float VALUE, int *EXPONENT);
    "frexpf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypePointer(SimTypeInt(signed=True), offset=0)],
        SimTypeFloat(size=32),
        arg_names=["value", "exponent"],
    ),
    # long double frexpl (long double VALUE, int *EXPONENT);
    "frexpl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypePointer(SimTypeInt(signed=True), offset=0)],
        SimTypeDouble(align_double=True),
        arg_names=["value", "exponent"],
    ),
    ...
    "ldexp": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeInt(signed=True)],
        SimTypeDouble(align_double=True),
        arg_names=["value", "exponent"],
    ),
    # float ldexpf (float VALUE, int EXPONENT);
    "ldexpf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeInt(signed=True)], SimTypeFloat(size=32), arg_names=["value", "exponent"]
    ),
    # long double ldexpl (long double VALUE, int EXPONENT);
    "ldexpl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeInt(signed=True)],
        SimTypeDouble(align_double=True),
        arg_names=["value", "exponent"],
    ),
    ...
    "scalb": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["value", "exponent"],
    ),
    # float scalbf (float VALUE, float EXPONENT);
    "scalbf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["value", "exponent"]
    ),
    # long double scalbl (long double VALUE, long double EXPONENT);
    "scalbl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["value", "exponent"],
    ),
    # double scalbn (double X, int N);
    "scalbn": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeInt(signed=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "n"],
    ),
    # float scalbnf (float X, int N);
    "scalbnf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeInt(signed=True)], SimTypeFloat(size=32), arg_names=["x", "n"]
    ),
    # long double scalbnl (long double X, int N);
    "scalbnl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeInt(signed=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "n"],
    ),
    ...
    "scalbln": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeLong(signed=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "n"],
    ),
    # float scalblnf (float X, long int N);
    "scalblnf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeLong(signed=True)], SimTypeFloat(size=32), arg_names=["x", "n"]
    ),
    # long double scalblnl (long double X, long int N);
    "scalblnl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeLong(signed=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "n"],
    ),
    ...
    "significand": SimTypeFunction(
        [SimTypeDouble(align_double=True)], SimTypeDouble(align_double=True), arg_names=["x"]
    ),
    # float significandf (float X);
    "significandf": SimTypeFunction([SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["x"]),
    # long double significandl (long double X);
    "significandl": SimTypeFunction(
        [SimTypeDouble(align_double=True)], SimTypeDouble(align_double=True), arg_names=["x"]
    ),
    ...
    "fromfp": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeInt(signed=True), SimTypeInt(signed=False)],
        SimTypeInt(signed=True, label="intmax_t"),
        arg_names=["x", "round", "width"],
    ),
    # intmax_t fromfpf (float X, int ROUND, unsigned int WIDTH);
    "fromfpf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeInt(signed=True), SimTypeInt(signed=False)],
        SimTypeInt(signed=True, label="intmax_t"),
        arg_names=["x", "round", "width"],
    ),
    # intmax_t fromfpl (long double X, int ROUND, unsigned int WIDTH);
    "fromfpl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeInt(signed=True), SimTypeInt(signed=False)],
        SimTypeInt(signed=True, label="intmax_t"),
        arg_names=["x", "round", "width"],
    ),
    ...
    "fmod": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["numerator", "denominator"],
    ),
    # float fmodf (float NUMERATOR, float DENOMINATOR);
    "fmodf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["numerator", "denominator"]
    ),
    # long double fmodl (long double NUMERATOR, long double DENOMINATOR);
    "fmodl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["numerator", "denominator"],
    ),
    ...
    "drem": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["numerator", "denominator"],
    ),
    # float dremf (float NUMERATOR, float DENOMINATOR);
    "dremf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["numerator", "denominator"]
    ),
    # long double dreml (long double NUMERATOR, long double DENOMINATOR);
    "dreml": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["numerator", "denominator"],
    ),
    # double copysign (double X, double Y);
    "copysign": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    # float copysignf (float X, float Y);
    "copysignf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["x", "y"]
    ),
    # long double copysignl (long double X, long double Y);
    "copysignl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    ...
    "nextafter": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    # float nextafterf (float X, float Y);
    "nextafterf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["x", "y"]
    ),
    # long double nextafterl (long double X, long double Y);
    "nextafterl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    ...
    "nexttoward": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    # float nexttowardf (float X, long double Y);
    "nexttowardf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeDouble(align_double=True)], SimTypeFloat(size=32), arg_names=["x", "y"]
    ),
    # long double nexttowardl (long double X, long double Y);
    "nexttowardl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    ...
    "canonicalizef": SimTypeFunction(
        [SimTypePointer(SimTypeFloat(size=32), offset=0), SimTypePointer(SimTypeFloat(size=32), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["cx", "x"],
    ),
    # int canonicalizel (long double *CX, const long double *X);
    "canonicalizel": SimTypeFunction(
        [
            SimTypePointer(SimTypeDouble(align_double=True), offset=0),
            SimTypePointer(SimTypeDouble(align_double=True), offset=0),
        ],
    ...
    "getpayload": SimTypeFunction(
        [SimTypePointer(SimTypeDouble(align_double=True), offset=0)], SimTypeDouble(align_double=True), arg_names=["x"]
    ),
    # float getpayloadf (const float *X);
    "getpayloadf": SimTypeFunction(
        [SimTypePointer(SimTypeFloat(size=32), offset=0)], SimTypeFloat(size=32), arg_names=["x"]
    ),
    # long double getpayloadl (const long double *X);
    "getpayloadl": SimTypeFunction(
        [SimTypePointer(SimTypeDouble(align_double=True), offset=0)], SimTypeDouble(align_double=True), arg_names=["x"]
    ),
    ...
    "setpayload": SimTypeFunction(
        [SimTypePointer(SimTypeDouble(align_double=True), offset=0), SimTypeDouble(align_double=True)],
        SimTypeInt(signed=True),
        arg_names=["x", "payload"],
    ),
    # int setpayloadf (float *X, float PAYLOAD);
    "setpayloadf": SimTypeFunction(
        [SimTypePointer(SimTypeFloat(size=32), offset=0), SimTypeFloat(size=32)],
        SimTypeInt(signed=True),
        arg_names=["x", "payload"],
    ),
    # int setpayloadl (long double *X, long double PAYLOAD);
    "setpayloadl": SimTypeFunction(
        [SimTypePointer(SimTypeDouble(align_double=True), offset=0), SimTypeDouble(align_double=True)],
        SimTypeInt(signed=True),
        arg_names=["x", "payload"],
    ),
    ...
    "totalorder": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeInt(signed=True),
        arg_names=["x", "y"],
    ),
    # int totalorderf (float X, float Y);
    "totalorderf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeInt(signed=True), arg_names=["x", "y"]
    ),
    # int totalorderl (long double X, long double Y);
    "totalorderl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeInt(signed=True),
        arg_names=["x", "y"],
    ),
    ...
    "totalordermag": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeInt(signed=True),
        arg_names=["x", "y"],
    ),
    # int totalordermagf (float X, float Y);
    "totalordermagf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeInt(signed=True), arg_names=["x", "y"]
    ),
    # int totalordermagl (long double X, long double Y);
    "totalordermagl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeInt(signed=True),
        arg_names=["x", "y"],
    ),
    ...
    "fmin": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    # float fminf (float X, float Y);
    "fminf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["x", "y"]
    ),
    # long double fminl (long double X, long double Y);
    "fminl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    ...
    "fmax": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    # float fmaxf (float X, float Y);
    "fmaxf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["x", "y"]
    ),
    # long double fmaxl (long double X, long double Y);
    "fmaxl": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    ...
    "fdim": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    # float fdimf (float X, float Y);
    "fdimf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32)], SimTypeFloat(size=32), arg_names=["x", "y"]
    ),
    # long double fdiml (long double X, long double Y);
    "fdiml": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y"],
    ),
    ...
    "fma": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y", "z"],
    ),
    # float fmaf (float X, float Y, float Z);
    "fmaf": SimTypeFunction(
        [SimTypeFloat(size=32), SimTypeFloat(size=32), SimTypeFloat(size=32)],
        SimTypeFloat(size=32),
        arg_names=["x", "y", "z"],
    ),
    # long double fmal (long double X, long double Y, long double Z);
    "fmal": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeDouble(align_double=True), SimTypeDouble(align_double=True)],
        SimTypeDouble(align_double=True),
        arg_names=["x", "y", "z"],
    ),
    ...
    "atoll": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeLongLong(signed=True), arg_names=["string"]
    ),
    # double strtod (const char *restrict STRING, char **restrict TAILPTR);
    "strtod": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0)],
        SimTypeDouble(align_double=True),
        arg_names=["string", "tailptr"],
    ),
    # float strtof (const char *STRING, char **TAILPTR);
    "strtof": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0)],
        SimTypeFloat(size=32),
        arg_names=["string", "tailptr"],
    ),
    # long double strtold (const char *STRING, char **TAILPTR);
    "strtold": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0)],
        SimTypeDouble(align_double=True),
        arg_names=["string", "tailptr"],
    ),
    ...
    "atof": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeDouble(align_double=True), arg_names=["string"]
    ),
    # int strfromd (char *restrict STRING, size_t SIZE, const char *restrict FORMAT, double VALUE);
    "strfromd": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeChar(), offset=0),
    ...
    "ecvt": SimTypeFunction(
        ...
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["value", "ndigit", "decpt", "neg"],
    ),
    # char * fcvt (double VALUE, int NDIGIT, int *DECPT, int *NEG);
    "fcvt": SimTypeFunction(
        [
            SimTypeDouble(align_double=True),
            SimTypeInt(signed=True),
            SimTypePointer(SimTypeInt(signed=True), offset=0),
    ...
    "gcvt": SimTypeFunction(
        [SimTypeDouble(align_double=True), SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["value", "ndigit", "buf"],
    ),
    # char * qecvt (long double VALUE, int NDIGIT, int *DECPT, int *NEG);
    "qecvt": SimTypeFunction(
        [
            SimTypeDouble(align_double=True),
            SimTypeInt(signed=True),
            SimTypePointer(SimTypeInt(signed=True), offset=0),
    ...
    "difftime": SimTypeFunction(
        [SimTypeLong(signed=True, label="time_t"), SimTypeLong(signed=True, label="time_t")],
        SimTypeDouble(align_double=True),
        arg_names=["time1", "time0"],
    ),
    # clock_t clock (void);
    "clock": SimTypeFunction([], SimTypeLong(signed=True, label="clock_t")),
    # clock_t times (struct tms *BUFFER);
    "times": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["tms"], offset=0)], SimTypeLong(signed=True, label="clock_t"), arg_names=["buffer"]
    ),
    # time_t time (time_t *RESULT);
    "time": SimTypeFunction(
        [SimTypePointer(SimTypeLong(signed=True, label="time_t"), offset=0)],
        SimTypeLong(signed=True, label="time_t"),
        arg_names=["result"],
    ),
    # int stime (const time_t *NEWTIME);
    "stime": SimTypeFunction(
        [SimTypePointer(SimTypeLong(signed=True, label="time_t"), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["newtime"],
    ),
    # int gettimeofday (struct timeval *TP, struct timezone *TZP);
    "gettimeofday": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["timeval"], offset=0), SimTypePointer(ALL_TYPES["timezone"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["tp", "tzp"],
    ),
    # int settimeofday (const struct timeval *TP, const struct timezone *TZP);
    "settimeofday": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["timeval"], offset=0), SimTypePointer(ALL_TYPES["timezone"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["tp", "tzp"],
    ),
    # int adjtime (const struct timeval *DELTA, struct timeval *OLDDELTA);
    "adjtime": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["timeval"], offset=0), SimTypePointer(ALL_TYPES["timeval"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["delta", "olddelta"],
    ),
    # int adjtimex (struct timex *TIMEX);
    "adjtimex": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["timex"], offset=0)], SimTypeInt(signed=True), arg_names=["timex"]
    ),
    # struct tm * localtime (const time_t *TIME);
    "localtime": SimTypeFunction(
        [SimTypePointer(SimTypeLong(signed=True, label="time_t"), offset=0)],
        SimTypePointer(ALL_TYPES["tm"], offset=0),
        arg_names=["time"],
    ),
    # struct tm * localtime_r (const time_t *TIME, struct tm *RESULTP);
    "localtime_r": SimTypeFunction(
        [SimTypePointer(SimTypeLong(signed=True, label="time_t"), offset=0), SimTypePointer(ALL_TYPES["tm"], offset=0)],
        SimTypePointer(ALL_TYPES["tm"], offset=0),
        arg_names=["time", "resultp"],
    ),
    # struct tm * gmtime (const time_t *TIME);
    "gmtime": SimTypeFunction(
        [SimTypePointer(SimTypeLong(signed=True, label="time_t"), offset=0)],
        SimTypePointer(ALL_TYPES["tm"], offset=0),
        arg_names=["time"],
    ),
    # struct tm * gmtime_r (const time_t *TIME, struct tm *RESULTP);
    "gmtime_r": SimTypeFunction(
        [SimTypePointer(SimTypeLong(signed=True, label="time_t"), offset=0), SimTypePointer(ALL_TYPES["tm"], offset=0)],
        SimTypePointer(ALL_TYPES["tm"], offset=0),
        arg_names=["time", "resultp"],
    ),
    # time_t mktime (struct tm *BROKENTIME);
    "mktime": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["tm"], offset=0)], SimTypeLong(signed=True, label="time_t"), arg_names=["brokentime"]
    ),
    # time_t timelocal (struct tm *BROKENTIME);
    "timelocal": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["tm"], offset=0)], SimTypeLong(signed=True, label="time_t"), arg_names=["brokentime"]
    ),
    # time_t timegm (struct tm *BROKENTIME);
    "timegm": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["tm"], offset=0)], SimTypeLong(signed=True, label="time_t"), arg_names=["brokentime"]
    ),
    # int ntp_gettime (struct ntptimeval *TPTR);
    "ntp_gettime": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["ntptimeval"], offset=0)], SimTypeInt(signed=True), arg_names=["tptr"]
    ),
    # int ntp_adjtime (struct timex *TPTR);
    "ntp_adjtime": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["timex"], offset=0)], SimTypeInt(signed=True), arg_names=["tptr"]
    ),
    # char * asctime (const struct tm *BROKENTIME);
    "asctime": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["tm"], offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["brokentime"]
    ),
    # char * asctime_r (const struct tm *BROKENTIME, char *BUFFER);
    "asctime_r": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["tm"], offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["brokentime", "buffer"],
    ),
    # char * ctime (const time_t *TIME);
    "ctime": SimTypeFunction(
        [SimTypePointer(SimTypeLong(signed=True, label="time_t"), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["time"],
    ),
    # char * ctime_r (const time_t *TIME, char *BUFFER);
    "ctime_r": SimTypeFunction(
        [SimTypePointer(SimTypeLong(signed=True, label="time_t"), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["time", "buffer"],
    ),
    # size_t strftime (char *S, size_t SIZE, const char *TEMPLATE, const struct tm *BROKENTIME);
    "strftime": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypeChar(), offset=0),
    ...
    "getdate": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(ALL_TYPES["tm"], offset=0), arg_names=["string"]
    ),
    # int getdate_r (const char *STRING, struct tm *TP);
    "getdate_r": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["tm"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["string", "tp"],
    ),
    # void tzset (void);
    ...
    "setitimer": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["itimerval"], offset=0),
            SimTypePointer(ALL_TYPES["itimerval"], offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["which", "new", "old"],
    ),
    # int getitimer (int WHICH, struct itimerval *OLD);
    "getitimer": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["itimerval"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["which", "old"],
    ),
    ...
    "nanosleep": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["timespec"], offset=0), SimTypePointer(ALL_TYPES["timespec"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["requested_time", "remaining"],
    ),
    # int getrusage (int PROCESSES, struct rusage *RUSAGE);
    "getrusage": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["rusage"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["processes", "rusage"],
    ),
    # int vtimes (struct vtimes *CURRENT, struct vtimes *CHILD);
    "vtimes": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["vtimes"], offset=0), SimTypePointer(ALL_TYPES["vtimes"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["current", "child"],
    ),
    # int getrlimit (int RESOURCE, struct rlimit *RLP);
    "getrlimit": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["rlimit"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["resource", "rlp"],
    ),
    # int getrlimit64 (int RESOURCE, struct rlimit64 *RLP);
    "getrlimit64": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["rlimit64"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["resource", "rlp"],
    ),
    # int setrlimit (int RESOURCE, const struct rlimit *RLP);
    "setrlimit": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["rlimit"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["resource", "rlp"],
    ),
    # int setrlimit64 (int RESOURCE, const struct rlimit64 *RLP);
    "setrlimit64": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(ALL_TYPES["rlimit64"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["resource", "rlp"],
    ),
    ...
    "vlimit": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["resource", "limit"]
    ),
    # int sched_setscheduler (pid_t PID, int POLICY, const struct sched_param *PARAM);
    "sched_setscheduler": SimTypeFunction(
        [
            SimTypeInt(signed=True, label="pid_t"),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["sched_param"], offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["pid", "policy", "param"],
    ),
    # int sched_getscheduler (pid_t PID);
    "sched_getscheduler": SimTypeFunction(
        [SimTypeInt(signed=True, label="pid_t")], SimTypeInt(signed=True), arg_names=["pid"]
    ),
    # int sched_setparam (pid_t PID, const struct sched_param *PARAM);
    "sched_setparam": SimTypeFunction(
        [SimTypeInt(signed=True, label="pid_t"), SimTypePointer(ALL_TYPES["sched_param"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["pid", "param"],
    ),
    # int sched_getparam (pid_t PID, struct sched_param *PARAM);
    "sched_getparam": SimTypeFunction(
        [SimTypeInt(signed=True, label="pid_t"), SimTypePointer(ALL_TYPES["sched_param"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["pid", "param"],
    ),
    ...
    "sched_rr_get_interval": SimTypeFunction(
        [SimTypeInt(signed=True, label="pid_t"), SimTypePointer(ALL_TYPES["timespec"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["pid", "interval"],
    ),
    # int sched_yield (void);
    "sched_yield": SimTypeFunction([], SimTypeInt(signed=True)),
    # int getpriority (int CLASS, int ID);
    "getpriority": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["class", "id"]
    ),
    # int setpriority (int CLASS, int ID, int NICEVAL);
    "setpriority": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["class", "id", "niceval"],
    ),
    ...
    "getloadavg": SimTypeFunction(
        [SimTypeFixedSizeArray(SimTypeDouble(align_double=True), 0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["loadavg", "nelem"],
    ),
    ...
    "strsignal": SimTypeFunction(
        [SimTypeInt(signed=True)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["signum"]
    ),
    # void psignal (int SIGNUM, const char *MESSAGE);
    "psignal": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeBottom(label="void"),
        arg_names=["signum", "message"],
    ),
    ...
    "kill": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["pid", "signum"],
    ),
    # int killpg (int PGID, int SIGNUM);
    "killpg": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["pgid", "signum"]
    ),
    # int sigemptyset (sigset_t *SET);
    "sigemptyset": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=True, label="sigset_t"), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["set"],
    ),
    # int sigfillset (sigset_t *SET);
    "sigfillset": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=True, label="sigset_t"), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["set"],
    ),
    # int sigaddset (sigset_t *SET, int SIGNUM);
    "sigaddset": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=True, label="sigset_t"), offset=0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["set", "signum"],
    ),
    # int sigdelset (sigset_t *SET, int SIGNUM);
    "sigdelset": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=True, label="sigset_t"), offset=0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["set", "signum"],
    ),
    # int sigismember (const sigset_t *SET, int SIGNUM);
    "sigismember": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=True, label="sigset_t"), offset=0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["set", "signum"],
    ),
    ...
    "sigstack": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["sigstack"], offset=0), SimTypePointer(ALL_TYPES["sigstack"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["stack", "oldstack"],
    ),
    # int siginterrupt (int SIGNUM, int FAILFLAG);
    "siginterrupt": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["signum", "failflag"]
    ),
    ...
    "getopt": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["argc", "argv", "options"],
    ),
    # int getopt_long (int ARGC, char *const *ARGV, const char *SHORTOPTS, const struct option *LONGOPTS, int *INDEXPTR);
    "getopt_long": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(ALL_TYPES["option"], offset=0),
            SimTypePointer(SimTypeInt(signed=True), offset=0),
        ],
        SimTypeInt(signed=True),
    ...
    "argp_usage": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["argp_state"], offset=0)], SimTypeBottom(label="void"), arg_names=["state"]
    ),
    # void argp_error (const struct argp_state *STATE, const char *FMT, ...);
    "argp_error": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["argp_state"], offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeBottom(label="void"),
        arg_names=["state", "fmt"],
        variadic=True,
    ),
    # void argp_failure (const struct argp_state *STATE, int STATUS, int ERRNUM, const char *FMT, ...);
    "argp_failure": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["argp_state"], offset=0),
            SimTypeInt(signed=True),
            SimTypeInt(signed=True),
            SimTypePointer(SimTypeChar(), offset=0),
        ],
        SimTypeBottom(label="void"),
        arg_names=["state", "status", "errnum", "fmt"],
        variadic=True,
    ),
    ...
    "getsubopt": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["optionp", "tokens", "valuep"],
    ),
    # char * getenv (const char *NAME);
    "getenv": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["name"]
    ),
    # char * secure_getenv (const char *NAME);
    "secure_getenv": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["name"]
    ),
    # int putenv (char *STRING);
    "putenv": SimTypeFunction([SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["string"]),
    # int setenv (const char *NAME, const char *VALUE, int REPLACE);
    "setenv": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["name", "value", "replace"],
    ),
    ...
    "syscall": SimTypeFunction(
        [SimTypeLong(signed=True)], SimTypeLong(signed=True), arg_names=["sysno"], variadic=True
    ),
    # void exit (int STATUS);
    "exit": SimTypeFunction([SimTypeInt(signed=True)], SimTypeBottom(label="void"), arg_names=["status"]),
    # int atexit (void (*FUNCTION));
    "atexit": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0)], SimTypeInt(signed=True), arg_names=["function"]
    ),
    # int on_exit (void (*FUNCTION));
    "on_exit": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0)], SimTypeInt(signed=True), arg_names=["function"]
    ),
    # void abort (void);
    ...
    "system": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["command"]
    ),
    # pid_t getpid (void);
    ...
    "execv": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeFixedSizeArray(SimTypePointer(SimTypeChar(), offset=0), 0)],
        SimTypeInt(signed=True),
        arg_names=["filename", "argv"],
    ),
    # int execl (const char *FILENAME, const char *ARG0, ...);
    "execl": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["filename", "arg0"],
        variadic=True,
    ),
    # int execve (const char *FILENAME, char *const ARGV[], char *const ENV[]);
    "execve": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeFixedSizeArray(SimTypePointer(SimTypeChar(), offset=0), 0),
            SimTypeFixedSizeArray(SimTypePointer(SimTypeChar(), offset=0), 0),
        ],
        SimTypeInt(signed=True),
        arg_names=["filename", "argv", "env"],
    ),
    # int execle (const char *FILENAME, const char *ARG0, ...);
    "execle": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeFixedSizeArray(SimTypePointer(SimTypeChar(), offset=0), 0)],
        SimTypeInt(signed=True),
        arg_names=["filename", "argv"],
    ),
    # int execvp (const char *FILENAME, char *const ARGV[]);
    "execvp": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeFixedSizeArray(SimTypePointer(SimTypeChar(), offset=0), 0)],
        SimTypeInt(signed=True),
        arg_names=["filename", "argv"],
    ),
    # int execvpe (const char *FILENAME, char *const ARGV[], char *const ENV[]);,
    "execvpe": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeFixedSizeArray(SimTypePointer(SimTypeChar(), offset=0), 0),
            SimTypeFixedSizeArray(SimTypePointer(SimTypeChar(), offset=0), 0),
    ...
    "waitpid": SimTypeFunction(
        ...
        SimTypeInt(signed=True, label="pid_t"),
        arg_names=["pid", "status_ptr", "options"],
    ),
    # pid_t wait (int *STATUS_PTR);
    "wait": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=True), offset=0)],
        SimTypeInt(signed=True, label="pid_t"),
        arg_names=["status_ptr"],
    ),
    # pid_t wait4 (pid_t PID, int *STATUS_PTR, int OPTIONS, struct rusage *USAGE);
    "wait4": SimTypeFunction(
        [
            SimTypeInt(signed=True, label="pid_t"),
            SimTypePointer(SimTypeInt(signed=True), offset=0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["rusage"], offset=0),
        ],
        SimTypeInt(signed=True, label="pid_t"),
        arg_names=["pid", "status_ptr", "options", "usage"],
    ),
    # pid_t wait3 (int *STATUS_PTR, int OPTIONS, struct rusage *USAGE);
    "wait3": SimTypeFunction(
        [
            SimTypePointer(SimTypeInt(signed=True), offset=0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["rusage"], offset=0),
        ...
        SimTypeInt(signed=True, label="pid_t"),
        arg_names=["status_ptr", "options", "usage"],
    ),
    # int semctl (int SEMID, int SEMNUM, int CMD);
    "semctl": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["semid", "semnum", "cmd"],
    ),
    # int semget (key_t KEY, int NSEMS, int SEMFLG);
    "semget": None,
    # int semop (int SEMID, struct sembuf *SOPS, size_t NSOPS);
    "semop": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["sembuf"], offset=0),
            SimTypeLong(signed=False, label="size_t"),
        ],
        SimTypeInt(signed=True),
        arg_names=["semid", "sops", "nsops"],
    ),
    # int semtimedop (int SEMID, struct sembuf *SOPS, size_t NSOPS, const struct timespec *TIMEOUT);
    "semtimedop": SimTypeFunction(
        [
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["sembuf"], offset=0),
            SimTypeLong(signed=False, label="size_t"),
    ...
    "sem_init": SimTypeFunction(
        [
            SimTypePointer(SimTypeInt(signed=False, label="sem_t"), offset=0),
            SimTypeInt(signed=True),
            SimTypeInt(signed=False),
        ],
        SimTypeInt(signed=True),
        arg_names=["sem", "pshared", "value"],
    ),
    # int sem_destroy (sem_t *SEM);
    "sem_destroy": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=False, label="sem_t"), offset=0)], SimTypeInt(signed=True), arg_names=["sem"]
    ),
    # sem_t *sem_open (const char *NAME, int OFLAG, ...);
    "sem_open": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypePointer(SimTypeInt(signed=False, label="sem_t"), offset=0),
        arg_names=["name", "oflag"],
        variadic=True,
    ),
    # int sem_close (sem_t *SEM);
    "sem_close": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=False, label="sem_t"), offset=0)], SimTypeInt(signed=True), arg_names=["sem"]
    ),
    # int sem_unlink (const char *NAME);
    "sem_unlink": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["name"]
    ),
    # int sem_wait (sem_t *SEM);
    "sem_wait": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=False, label="sem_t"), offset=0)], SimTypeInt(signed=True), arg_names=["sem"]
    ),
    # int sem_timedwait (sem_t *SEM, const struct timespec *ABSTIME);
    "sem_timedwait": SimTypeFunction(
        [
            SimTypePointer(SimTypeInt(signed=False, label="sem_t"), offset=0),
            SimTypePointer(ALL_TYPES["timespec"], offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["sem", "abstime"],
    ),
    # int sem_trywait (sem_t *SEM);
    "sem_trywait": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=False, label="sem_t"), offset=0)], SimTypeInt(signed=True), arg_names=["sem"]
    ),
    # int sem_post (sem_t *SEM);
    "sem_post": SimTypeFunction(
        [SimTypePointer(SimTypeInt(signed=False, label="sem_t"), offset=0)], SimTypeInt(signed=True), arg_names=["sem"]
    ),
    # int sem_getvalue (sem_t *SEM, int *SVAL);
    "sem_getvalue": SimTypeFunction(
        [
            SimTypePointer(SimTypeInt(signed=False, label="sem_t"), offset=0),
            SimTypePointer(SimTypeInt(signed=True), offset=0),
        ],
    ...
    "ctermid": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["string"]
    ),
    # pid_t setsid (void);
    "setsid": SimTypeFunction([], SimTypeInt(signed=True, label="pid_t")),
    # pid_t getsid (pid_t PID);
    "getsid": SimTypeFunction(
        [SimTypeInt(signed=True, label="pid_t")], SimTypeInt(signed=True, label="pid_t"), arg_names=["pid"]
    ),
    # pid_t getpgrp (void);
    ...
    "setpgid": SimTypeFunction(
        [SimTypeInt(signed=True, label="pid_t"), SimTypeInt(signed=True, label="pid_t")],
        SimTypeInt(signed=True),
        arg_names=["pid", "pgid"],
    ),
    # int setpgrp (pid_t PID, pid_t PGID);
    "setpgrp": SimTypeFunction(
        [SimTypeInt(signed=True, label="pid_t"), SimTypeInt(signed=True, label="pid_t")],
        SimTypeInt(signed=True),
        arg_names=["pid", "pgid"],
    ),
    # pid_t tcgetpgrp (int FILEDES);
    "tcgetpgrp": SimTypeFunction(
        [SimTypeInt(signed=True)], SimTypeInt(signed=True, label="pid_t"), arg_names=["filedes"]
    ),
    # int tcsetpgrp (int FILEDES, pid_t PGID);
    "tcsetpgrp": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True, label="pid_t")],
        SimTypeInt(signed=True),
        arg_names=["filedes", "pgid"],
    ),
    # pid_t tcgetsid (int FILDES);
    "tcgetsid": SimTypeFunction(
        [SimTypeInt(signed=True)], SimTypeInt(signed=True, label="pid_t"), arg_names=["fildes"]
    ),
    # uid_t getuid (void);
    ...
    "getgroups": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeInt(signed=False, label="gid_t"), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["count", "groups"],
    ),
    # int seteuid (uid_t NEWEUID);
    "seteuid": SimTypeFunction(
        [SimTypeInt(signed=False, label="uid_t")], SimTypeInt(signed=True), arg_names=["neweuid"]
    ),
    # int setuid (uid_t NEWUID);
    "setuid": SimTypeFunction([SimTypeInt(signed=False, label="uid_t")], SimTypeInt(signed=True), arg_names=["newuid"]),
    # int setreuid (uid_t RUID, uid_t EUID);
    "setreuid": SimTypeFunction(
        [SimTypeInt(signed=False, label="uid_t"), SimTypeInt(signed=False, label="uid_t")],
        SimTypeInt(signed=True),
        arg_names=["ruid", "euid"],
    ),
    # int setegid (gid_t NEWGID);
    "setegid": SimTypeFunction(
        [SimTypeInt(signed=False, label="gid_t")], SimTypeInt(signed=True), arg_names=["newgid"]
    ),
    # int setgid (gid_t NEWGID);
    "setgid": SimTypeFunction([SimTypeInt(signed=False, label="gid_t")], SimTypeInt(signed=True), arg_names=["newgid"]),
    # int setregid (gid_t RGID, gid_t EGID);
    "setregid": SimTypeFunction(
        [SimTypeInt(signed=False, label="gid_t"), SimTypeInt(signed=False, label="gid_t")],
        SimTypeInt(signed=True),
        arg_names=["rgid", "egid"],
    ),
    # int setgroups (size_t COUNT, const gid_t *GROUPS);
    "setgroups": SimTypeFunction(
        [SimTypeLong(signed=False, label="size_t"), SimTypePointer(SimTypeInt(signed=False, label="gid_t"), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["count", "groups"],
    ),
    # int initgroups (const char *USER, gid_t GROUP);
    "initgroups": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=False, label="gid_t")],
        SimTypeInt(signed=True),
        arg_names=["user", "group"],
    ),
    # int getgrouplist (const char *USER, gid_t GROUP, gid_t *GROUPS, int *NGROUPS);
    "getgrouplist": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeInt(signed=False, label="gid_t"),
            SimTypePointer(SimTypeInt(signed=False, label="gid_t"), offset=0),
            SimTypePointer(SimTypeInt(signed=True), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["user", "group", "groups", "ngroups"],
    ),
    # char * getlogin (void);
    "getlogin": SimTypeFunction([], SimTypePointer(SimTypeChar(), offset=0)),
    # char * cuserid (char *STRING);
    "cuserid": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["string"]
    ),
    # void setutent (void);
    ...
    "getutid": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["utmp"], offset=0)], SimTypePointer(ALL_TYPES["utmp"], offset=0), arg_names=["id"]
    ),
    # struct utmp * getutline (const struct utmp *LINE);
    "getutline": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["utmp"], offset=0)], SimTypePointer(ALL_TYPES["utmp"], offset=0), arg_names=["line"]
    ),
    # struct utmp * pututline (const struct utmp *UTMP);
    "pututline": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["utmp"], offset=0)], SimTypePointer(ALL_TYPES["utmp"], offset=0), arg_names=["utmp"]
    ),
    # int getutent_r (struct utmp *BUFFER, struct utmp **RESULT);
    "getutent_r": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["utmp"], offset=0),
            SimTypePointer(SimTypePointer(ALL_TYPES["utmp"], offset=0), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["buffer", "result"],
    ),
    # int getutid_r (const struct utmp *ID, struct utmp *BUFFER, struct utmp **RESULT);
    "getutid_r": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["utmp"], offset=0),
            SimTypePointer(ALL_TYPES["utmp"], offset=0),
            SimTypePointer(SimTypePointer(ALL_TYPES["utmp"], offset=0), offset=0),
    ...
    "updwtmp": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["utmp"], offset=0)],
        SimTypeBottom(label="void"),
        arg_names=["wtmp_file", "utmp"],
    ),
    # void setutxent (void);
    ...
    "getutxid": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["utmpx"], offset=0)], SimTypePointer(ALL_TYPES["utmpx"], offset=0), arg_names=["id"]
    ),
    # struct utmpx * getutxline (const struct utmpx *LINE);
    "getutxline": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["utmpx"], offset=0)], SimTypePointer(ALL_TYPES["utmpx"], offset=0), arg_names=["line"]
    ),
    # struct utmpx * pututxline (const struct utmpx *UTMP);
    "pututxline": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["utmpx"], offset=0)], SimTypePointer(ALL_TYPES["utmpx"], offset=0), arg_names=["utmp"]
    ),
    # int utmpxname (const char *FILE);
    "utmpxname": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["file"]
    ),
    # int getutmp (const struct utmpx *UTMPX, struct utmp *UTMP);
    "getutmp": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["utmpx"], offset=0), SimTypePointer(ALL_TYPES["utmp"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["utmpx", "utmp"],
    ),
    # int getutmpx (const struct utmp *UTMP, struct utmpx *UTMPX);
    "getutmpx": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["utmp"], offset=0), SimTypePointer(ALL_TYPES["utmpx"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["utmp", "utmpx"],
    ),
    # int login_tty (int FILEDES);
    "login_tty": SimTypeFunction([SimTypeInt(signed=True)], SimTypeInt(signed=True), arg_names=["filedes"]),
    # void login (const struct utmp *ENTRY);
    "login": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["utmp"], offset=0)], SimTypeBottom(label="void"), arg_names=["entry"]
    ),
    # int logout (const char *UT_LINE);
    "logout": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["ut_line"]
    ),
    # void logwtmp (const char *UT_LINE, const char *UT_NAME, const char *UT_HOST);
    "logwtmp": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
        ...
        SimTypeBottom(label="void"),
        arg_names=["ut_line", "ut_name", "ut_host"],
    ),
    # struct passwd * getpwuid (uid_t UID);
    "getpwuid": SimTypeFunction(
        [SimTypeInt(signed=False, label="uid_t")], SimTypePointer(ALL_TYPES["passwd"], offset=0), arg_names=["uid"]
    ),
    # int getpwuid_r (uid_t UID, struct passwd *RESULT_BUF, char *BUFFER, size_t BUFLEN, struct passwd **RESULT);
    "getpwuid_r": SimTypeFunction(
        [
            SimTypeInt(signed=False, label="uid_t"),
            SimTypePointer(ALL_TYPES["passwd"], offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypePointer(ALL_TYPES["passwd"], offset=0), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["uid", "result_buf", "buffer", "buflen", "result"],
    ),
    # struct passwd * getpwnam (const char *NAME);
    "getpwnam": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(ALL_TYPES["passwd"], offset=0), arg_names=["name"]
    ),
    # int getpwnam_r (const char *NAME, struct passwd *RESULT_BUF, char *BUFFER, size_t BUFLEN, struct passwd **RESULT);
    "getpwnam_r": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(ALL_TYPES["passwd"], offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
    ...
    "putpwent": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["passwd"], offset=0), SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["p", "stream"],
    ),
    # struct group * getgrgid (gid_t GID);
    "getgrgid": SimTypeFunction(
        [SimTypeInt(signed=False, label="gid_t")], SimTypePointer(ALL_TYPES["group"], offset=0), arg_names=["gid"]
    ),
    # int getgrgid_r (gid_t GID, struct group *RESULT_BUF, char *BUFFER, size_t BUFLEN, struct group **RESULT);
    "getgrgid_r": SimTypeFunction(
        [
            SimTypeInt(signed=False, label="gid_t"),
            SimTypePointer(ALL_TYPES["group"], offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypePointer(SimTypePointer(ALL_TYPES["group"], offset=0), offset=0),
        ],
        SimTypeInt(signed=True),
        arg_names=["gid", "result_buf", "buffer", "buflen", "result"],
    ),
    # struct group * getgrnam (const char *NAME);
    "getgrnam": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(ALL_TYPES["group"], offset=0), arg_names=["name"]
    ),
    # int getgrnam_r (const char *NAME, struct group *RESULT_BUF, char *BUFFER, size_t BUFLEN, struct group **RESULT);
    "getgrnam_r": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(ALL_TYPES["group"], offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
    ...
    "setnetgrent": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeInt(signed=True), arg_names=["netgroup"]
    ),
    # int getnetgrent (char **HOSTP, char **USERP, char **DOMAINP);
    "getnetgrent": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
            SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
    ...
    "innetgr": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["netgroup", "host", "user", "domain"],
    ),
    # int gethostname (char *NAME, size_t SIZE);
    "gethostname": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["name", "size"],
    ),
    # int sethostname (const char *NAME, size_t LENGTH);
    "sethostname": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["name", "length"],
    ),
    # int getdomainnname (char *NAME, size_t LENGTH);
    "getdomainnname": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["name", "length"],
    ),
    # int setdomainname (const char *NAME, size_t LENGTH);
    "setdomainname": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["name", "length"],
    ),
    ...
    "uname": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["utsname"], offset=0)], SimTypeInt(signed=True), arg_names=["info"]
    ),
    # int setfsent (void);
    ...
    "getfsspec": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(ALL_TYPES["fstab"], offset=0), arg_names=["name"]
    ),
    # struct fstab * getfsfile (const char *NAME);
    "getfsfile": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(ALL_TYPES["fstab"], offset=0), arg_names=["name"]
    ),
    # FILE * setmntent (const char *FILE, const char *MODE);
    "setmntent": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
        arg_names=["file", "mode"],
    ),
    # int endmntent (FILE *STREAM);
    "endmntent": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)], SimTypeInt(signed=True), arg_names=["stream"]
    ),
    # struct mntent * getmntent (FILE *STREAM);
    "getmntent": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0)],
        SimTypePointer(ALL_TYPES["mntent"], offset=0),
        arg_names=["stream"],
    ),
    # struct mntent * getmntent_r (FILE *STREAM, struct mntent *RESULT, char *BUFFER, int BUFSIZE);
    "getmntent_r": SimTypeFunction(
        [
            SimTypePointer(ALL_TYPES["FILE_t"], offset=0),
            SimTypePointer(ALL_TYPES["mntent"], offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
        ...
        SimTypePointer(ALL_TYPES["mntent"], offset=0),
        arg_names=["stream", "result", "buffer", "bufsize"],
    ),
    # int addmntent (FILE *STREAM, const struct mntent *MNT);
    "addmntent": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["FILE_t"], offset=0), SimTypePointer(ALL_TYPES["mntent"], offset=0)],
        SimTypeInt(signed=True),
        arg_names=["stream", "mnt"],
    ),
    # char * hasmntopt (const struct mntent *MNT, const char *OPT);
    "hasmntopt": SimTypeFunction(
        [SimTypePointer(ALL_TYPES["mntent"], offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["mnt", "opt"],
    ),
    # int mount (const char *SPECIAL_FILE, const char *DIR, const char *FSTYPE, unsigned long int OPTIONS, const void *DATA);
    "mount": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
        ...
        SimTypeInt(signed=True),
        arg_names=["special_file", "dir", "fstype", "options", "data"],
    ),
    # int umount2 (const char *FILE, int FLAGS);
    "umount2": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["file", "flags"],
    ),
    ...
    "sysctl": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["names", "nlen", "oldval", "oldlenp", "newval", "newlen"],
    ),
    # long int sysconf (int PARAMETER);
    "sysconf": SimTypeFunction([SimTypeInt(signed=True)], SimTypeLong(signed=True), arg_names=["parameter"]),
    # long int pathconf (const char *FILENAME, int PARAMETER);
    "pathconf": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypeLong(signed=True),
        arg_names=["filename", "parameter"],
    ),
    # long int fpathconf (int FILEDES, int PARAMETER);
    "fpathconf": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypeInt(signed=True)], SimTypeLong(signed=True), arg_names=["filedes", "parameter"]
    ),
    # size_t confstr (int PARAMETER, char *BUF, size_t LEN);
    "confstr": SimTypeFunction(
        [SimTypeInt(signed=True), SimTypePointer(SimTypeChar(), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeLong(signed=False, label="size_t"),
        arg_names=["parameter", "buf", "len"],
    ),
    # char * getpass (const char *PROMPT);
    "getpass": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypePointer(SimTypeChar(), offset=0), arg_names=["prompt"]
    ),
    # char * crypt (const char *KEY, const char *SALT);
    "crypt": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(SimTypeChar(), offset=0)],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["key", "salt"],
    ),
    # char * crypt_r (const char *KEY, const char *SALT, struct crypt_data * DATA);
    "crypt_r": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypePointer(ALL_TYPES["crypt_data"], offset=0),
        ],
        SimTypePointer(SimTypeChar(), offset=0),
        arg_names=["key", "salt", "data"],
    ),
    # void setkey (const char *KEY);
    "setkey": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeBottom(label="void"), arg_names=["key"]
    ),
    # void encrypt (char *BLOCK, int EDFLAG);
    "encrypt": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypeInt(signed=True)],
        SimTypeBottom(label="void"),
        arg_names=["block", "edflag"],
    ),
    # void setkey_r (const char *KEY, struct crypt_data * DATA);
    "setkey_r": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0), SimTypePointer(ALL_TYPES["crypt_data"], offset=0)],
        SimTypeBottom(label="void"),
        arg_names=["key", "data"],
    ),
    # void encrypt_r (char *BLOCK, int EDFLAG, struct crypt_data * DATA);
    "encrypt_r": SimTypeFunction(
        [
            SimTypePointer(SimTypeChar(), offset=0),
            SimTypeInt(signed=True),
            SimTypePointer(ALL_TYPES["crypt_data"], offset=0),
    ...
    "cbc_crypt": SimTypeFunction(
        ...
        SimTypeInt(signed=True),
        arg_names=["key", "blocks", "len", "mode", "ivec"],
    ),
    # void des_setparity (char *KEY);
    "des_setparity": SimTypeFunction(
        [SimTypePointer(SimTypeChar(), offset=0)], SimTypeBottom(label="void"), arg_names=["key"]
    ),
    # int getentropy (void *BUFFER, size_t LENGTH);
    "getentropy": SimTypeFunction(
        [SimTypePointer(SimTypeBottom(label="void"), offset=0), SimTypeLong(signed=False, label="size_t")],
        SimTypeInt(signed=True),
        arg_names=["buffer", "length"],
    ),
    # ssize_t getrandom (void *BUFFER, size_t LENGTH, unsigned int FLAGS);
    "getrandom": SimTypeFunction(
        [
            SimTypePointer(SimTypeBottom(label="void"), offset=0),
            SimTypeLong(signed=False, label="size_t"),
            SimTypeInt(signed=False),
        ...
        SimTypeLong(signed=True, label="ssize_t"),
        arg_names=["buffer", "length", "flags"],
    ),
    # int backtrace (void **BUFFER, int SIZE);
    "backtrace": SimTypeFunction(
        [SimTypePointer(SimTypePointer(SimTypeBottom(label="void"), offset=0), offset=0), SimTypeInt(signed=True)],
        SimTypeInt(signed=True),
        arg_names=["buffer", "size"],
    ),
    # char ** backtrace_symbols (void *const *BUFFER, int SIZE);
    "backtrace_symbols": SimTypeFunction(
        [SimTypePointer(SimTypePointer(SimTypeBottom(label="void"), offset=0), offset=0), SimTypeInt(signed=True)],
        SimTypePointer(SimTypePointer(SimTypeChar(), offset=0), offset=0),
        arg_names=["buffer", "size"],
    ),
    # void backtrace_symbols_fd (void *const *BUFFER, int SIZE, int FD);
    "backtrace_symbols_fd": SimTypeFunction(
        [
            SimTypePointer(SimTypePointer(SimTypeBottom(label="void"), offset=0), offset=0),
            SimTypeInt(signed=True),
            SimTypeInt(signed=True),
        ...
        SimTypeBottom(label="void"),
        arg_names=["buffer", "size", "fd"],
    ),
    # int pthread_key_create (pthread_key_t *KEY, void (*DESTRUCTOR);
    "pthread_key_create": None,
    # int pthread_key_delete (pthread_key_t KEY);
    "pthread_key_delete": SimTypeFunction(
        [SimTypeInt(signed=False, label="pthread_key_t")], SimTypeInt(signed=True), arg_names=["key"]
    ),
    # void *pthread_getspecific (pthread_key_t KEY);
    "pthread_getspecific": SimTypeFunction(
        [SimTypeInt(signed=False, label="pthread_key_t")],
        SimTypePointer(SimTypeBottom(label="void"), offset=0),
        arg_names=["key"],
    ),
    # int pthread_setspecific (pthread_key_t KEY, const void *VALUE);
    "pthread_setspecific": SimTypeFunction(
        [SimTypeInt(signed=False, label="pthread_key_t"), SimTypePointer(SimTypeBottom(label="void"), offset=0)],
        SimTypeInt(signed=True),
        arg_names=["key", "value"],
    ),
...
_l.debug(
    "Libc provides %d function prototypes, and has %d unsupported function prototypes.", proto_count, unsupported_count
)
